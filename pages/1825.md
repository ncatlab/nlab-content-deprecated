...
* These spheres, or rather their underlying [[topological space]]s or [[simplicial set]]s, are fundamental in (ungeneralised) [[homotopy theory]].  In a sense, [[Whitehead's theorem]] says that these are all that you need; no further [[generalized (Eilenberg-Steenrod) homotopy theory|generalised homotopy theory]] (in a sense [[Eckmannâ€“Hilton duality|dual]] to [[Eilenbergâ€“Steenrod cohomology theory]]) is needed.
...
Note that this violates the convention that a $1$-foo is a foo; instead the ruling convention being used is that an $n$-foo has dimension $n$.  One could follow both by saying â€˜$n$-circleâ€™ instead, although this might get confused with the $n$-[[torus]].
