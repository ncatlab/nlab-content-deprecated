...
has the structure of a [[Batanin Ï‰-groupoid]].  This can be found in:
...
* The usual notions of *quotient type* make little sense without extensional identity types.  In the 1-categorical world, quotient types correspond to [[exact categories]], while the appropriate notion of "exactness" for an $(\infty,1)$-category deals with [[groupoid objects in an (âˆž,1)-category]].  It remains to be seen how to phrase a corresponding axiom in the type theory.
...
The archetypical [[(âˆž,1)-topos]] is [[âˆžGrpd]]. This is to be thought of as the [[vertical categorification|(âˆž,1)-categorification]] of the archetypical 1-[[topos]] [[Set]].
...
Here we look at the $(\infty,1)$-categorical analog of that discussion,  step-by-step, now everything internal to [[âˆžGrpd]].
...
* The _subobject classifier_ of $\infty Grpd$ is 
  ...
  See [[(sub)object classifier in an (âˆž,1)-topos]].
...
[[!redirects internal logic of an (âˆž,1)-topos]]
