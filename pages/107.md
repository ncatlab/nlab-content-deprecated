...
â€“ a semistrict version will suffice. One form of semistrictness has everything strict 
...
However, there are other possible â€œshadesâ€ of semistrictness and the above 
...
=--
E. Cheng and N. Gurskiâ€™s,  _The periodic table of $n$-categories for low dimensions I_ ([arXiv](http://arxiv.org/abs/0708.1178))
...
* {#KapranovVoevodsky91} [[Mikhail Kapranov]],  [[Vladimir Voevodsky]],  _$\infty$-Groupoids and homotopy types_, Cahiers de Topologie et GÃ©omÃ©trie DiffÃ©rentielle CatÃ©goriques, 32 no. 1 (1991), p. 29-46  ([Numdam](http://www.numdam.org/item?id=CTGDC_1991__32_1_29_0))
...
> I think that the argument of (K. and V.) (which is unclear on the question of identity elements) actually serves to prove the above statement. I have called the above statement a â€œconjectureâ€ because I havenâ€™t checked this.


[[!redirects Simpson conjecture]]
[[!redirects Simpson's conjecture]]
[[!redirects Simpsonâ€™s conjecture]]
[[!redirects Simpson\'s conjecture]]
[[!redirects Simpson&#x27;s conjecture]]
[[!redirects Simpson&amp;#x27;s conjecture]]