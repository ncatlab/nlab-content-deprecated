...
Notice the $Id$-labels, which indicate that the edges and faces labeled by them are "thin" in much the same way as an [[identity morphism]] is thin (notice however that a cubical set by itself is not equipped with a notion of composition of cubes. If it were, we'd call it a [[cubical Ï‰-category]]).
...
* [[Jean-Pierre Serre]], _Homologie singuliÃ¨re des espaces fibrÃ©s_ , Ann.
...
* [[Dan Kan]], _Abstract homotopy I_ , Proc. Nat. Acad. Sci. U.S.A. **41** (1955) pp.1092â€“1096. ([pdf](http://www.ncbi.nlm.nih.gov/pmc/articles/PMC528202/pdf/pnas00727-0082.pdf))
 {#Kan}
...
* Victor Gugenheim, _On supercomplexes_ Trans. Amer. Math. Soc. 85 (1957), 35â€“51 [PDF](https://www.ams.org/journals/tran/1957-085-01/S0002-9947-1957-0086299-1/S0002-9947-1957-0086299-1.pdf)
...
Cubical sets as models for [[strict Ï‰-groupoids]] are discussed in

* [[Ronnie Brown]], P. Higgins, _The equivalence of $\omega$-groupoids and cubical $T$-complexes_, Cahiers de Topologie et GÃ©omÃ©trie DiffÃ©rentielle CatÃ©goriques, 22 no. 4 (1981), p. 349-370  ([pdf](http://archive.numdam.org/ARCHIVE/CTGDC/CTGDC_1981__22_4/CTGDC_1981__22_4_349_0/CTGDC_1981__22_4_349_0.pdf)).
