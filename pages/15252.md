...
On a [[KÃ¤hler manifold]] $X$ a _Hodge cycle_ is a $2p$-[[cycle]] in integral [[ordinary homology]] which corresponds to an element in Dolbeault homology of bidegree $(p,p)$.
...
### For KÃ¤hler manifolds

+-- {: .num_defn #HodgeCohomologyGroupsForKaehlerManifolds}
###### Definition

For  $X$ be a [[KÃ¤hler manifold]] with [[Dolbeault cohomology]] groups $H^{p,q}(X)$, then for any $p \in \mathbb{N}$ the group  of **Hodge cohomology classes** represented by **Hodge cocycles** is the [[fiber product]] 
...
If the complex analytic space $X$ happens to carry the structure of a  [[KÃ¤hler manifold]], then definition \ref{HodgeCohomologyGroupsForComplexAnalytic} reduces to definition \ref{HodgeCohomologyGroupsForKaehlerManifolds}. 
...
* {#EsnaultViehweg88} [[HÃ©lÃ¨ne Esnault]], [[Eckart Viehweg]], section 7.8 of _Deligne-Beilinson cohomology_ in Rapoport, Schappacher, Schneider (eds.) _Beilinson's Conjectures on Special Values of L-Functions_ . Perspectives in Math. 4, Academic Press (1988) 43 - 91 ([pdf](http://www.uni-due.de/~mat903/preprints/ec/deligne_beilinson.pdf))
