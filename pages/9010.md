...
Let $R$ be a [[commutative ring]], or more generally an [[E-âˆž ring]]. By the discussion at [[2-vector space]] consider the [[2-category]]

$$
  2 Vect_R \simeq Alg_R
$$ 

[[equivalence of 2-categories|equivalent]] to that whose objects are [[associative algebras]] (or generally [[A-âˆž algebra|algebras]]) $A$ over $R$, (being placeholders for the 2-vector space $A Mod$ which is the category of [[modules]] over $A$) whose [[1-morphisms]] are [[bimodules]] between these algebras (inducing linear functors between the corresponding 2-vector spaces = categories of modules) and whose [[2-morphisms]] are [[homomorphisms]] between those. 
...
* [[Peter Donovan]], [[Max Karoubi]], _Graded Brauer groups and $K$-theory with local coefficients_, Publications MathÃ©matiques de l'IHÃ‰S, 38 (1970), p. 5-25  ([numdam](http://www.numdam.org/item?id=PMIHES_1970__38__5_0))
 {#DonovanKaroubi}
