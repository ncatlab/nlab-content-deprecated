...
of [[cocycle]] [[âˆž-groupoid]] (with respect to any ambient [[(âˆž,1)-topos]] $\mathbf{H}$, such as [[Top]] $\simeq$ [[âˆžGrpd]]), where $\beta_2$ is the [[Bockstein homomorphism|Bockstein morphism]] asociated with the multiplication by 2.
