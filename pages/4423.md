...
More generally, there is a notion of curvature characteristic forms of [[L-âˆž-algebra]]-valued differential forms and [[schreiber:âˆž-Lie algebroid valued differential forms]].
...
Recall that a morphism of [[âˆž-Lie algebroid]]s

$$
  T X \to b^n \mathbb{R}
$$

is equivalently a closed $n$-form on $X$. The data of an [[Ehresmann connection]] on $P$ then induces the following diagram of [[âˆž-Lie algebroid]]s
