...
**VopÄ›nka's principle** is a [[large cardinal]] axiom which implies a good deal of simplification in the theory of [[locally presentable categories]].  
...
### The VopÄ›nka principle

VopÄ›nka's principle has many equivalent statements.  Here are a few:
...
### The weak VopÄ›nka principle

The VopÄ›nka principle implies the weak VopÄ›nka principle.
...
### Relativized versions of VopÄ›nka's principle

VopÄ›nka's principle can be relativized to levels of the [[LÃ©vy hierarchy]] by restricting the complexity of the (definable) classes to which it is applied.  The following theorems are from ([BCMR](#BagariaCasacubertaMathiasRosicky)).
...
Let $C$ be a [[locally presentable (âˆž,1)-category]] and $Z$ a class of morphisms in $C$. Then the reflective [[localization of an (âˆž,1)-category|localization]] of $C$ at $W$ extsts. 
...
As usually stated, VopÄ›nka's principle is not formalizable in first-order [[ZF]] set theory, because it involves a "second-order" [[quantifier|quantification]] over [[proper classes]] ("...there does not exist a large discrete subcategory...").  It can, however, be formalized in this way in a class-set theory such as [[NBG]].

On the other hand, it can be formalized in ZF as a first-order axiom schema consisting of one axiom for each class-defining formula $\phi$, stating that "$\phi$ does not define a class which is a large discrete subcategory..."  We might call this axiom schema the **VopÄ›nka axiom scheme**.  As in most situations of this sort, the first-order VopÄ›nka scheme is appreciably weaker than the second-order VopÄ›nka principle.  See, for instance, [this MO question](http://mathoverflow.net/questions/45602/can-vopenkas-principle-be-violated-definably) and answer.


### VopÄ›nka cardinals

Unlike some large cardinal axioms, VopÄ›nka's principle does not appear to be merely an assertion that "there exist very large cardinals" but rather an assertion about the precise size of the "universe" (the "boundary" between sets and proper classes).  In other words, the universe could be "too big" for VopÄ›nka's principle to hold, in addition to being "too small."

(The equivalence of VopÄ›nka's principle with the existence of [[C(n)-extendible cardinals]] may appear to contradict this.  However, the property of being $C(n)$-extendible itself "depends on the size of the whole universe" in a sense.)

More precisely, if $\kappa$ is a cardinal such that $V_\kappa$ satisfies ZFC + VopÄ›nka's principle, then knowing that $\lambda\gt\kappa$ does not necessarily imply that $V_\lambda$ also satifies VopÄ›nka's principle.  By contrast, if $V_\kappa$ satisfies ZFC + "there exists a [[measurable cardinal]]" (say), then there must be a measurable cardinal less than $\kappa$, and that measurable cardinal will still exist in $V_\lambda$ for any $\lambda\gt\kappa$.  On the other hand, large cardinal axioms such as "there exist arbitrarily large measurable cardinals" have the same property that VopÄ›nka's principle does: even if measurable cardinals are unbounded below $\kappa$, they will not be unbounded below $\lambda$ if $\lambda$ is the next greatest [[inaccessible cardinal]] after $\kappa$.

Relativizing VopÄ›nka's principle to cardinals also raises the same first- versus second-order issues as above.  We say that a **VopÄ›nka cardinal** is one where VopÄ›nka's principle holds "in $V_\kappa$" where the quantification over classes is interpreted as quantification over all subsets of $V_\kappa$.  By contrast, we could define an **almost-VopÄ›nka cardinal** to be one where $V_\kappa$ satisfies the first-order VopÄ›nka scheme.  Then one can show, using the Mahlo reflection principle (see [here](http://mathoverflow.net/questions/45602/can-vopenkas-principle-be-violated-definably/46538#46538) again), that every VopÄ›nka cardinal $\kappa$  is a limit of $\kappa$-many almost-VopÄ›nka cardinals, and in particular the smallest almost-VopÄ›nka cardinal cannot be VopÄ›nka.  Thus, being VopÄ›nka is much stronger than being almost-VopÄ›nka.

### Definable counterexamples

If VopÄ›nka's principle fails, then there exist counterexamples to all of its equivalent statements, such as a large discrete full subcategory of a locally presentable category.  If VopÄ›nka's principle fails but the first-order VopÄ›nka scheme holds, then no such counterexamples can be explicitly definable.

On the other hand, if the VopÄ›nka scheme also fails, then there will be explicit finite formulas one can write down which define counterexamples.  However, there is no "universal" counterexample, in the following sense: if VopÄ›nka's principle is consistent, then for any class-defining formula $\phi$, there is a model of set theory in which VopÄ›nka's principle fails (and even in which the first-order VopÄ›nka scheme fails), but in which $\phi$ does not define a counterexample to it.  See [here](http://mathoverflow.net/questions/45602/can-vopenkas-principle-be-violated-definably/46538#46538) yet again.
...
* [[Jiri Adamek]], [[JiÅ™Ã­ RosickÃ½]], _[[Locally presentable and accessible categories]]_,  London Mathematical Society Lecture Note Series 189
{#AdamekRosicky}

The relation to [[combinatorial model categories]] is discussed in

* [[JiÅ™Ã­ RosickÃ½]], _Are all cofibrantly generated model categories combinatorial?_ ([ps](http://www.math.muni.cz/~rosicky/papers/cof1.ps))
{#Rosicky}
...
* [[JiÅ™Ã­ RosickÃ½]], [[Walter Tholen]], _Left-determined model categories and universal homotopy theories_  Transactions of the American Mathematical Society
...
[[!redirects VopÄ›nka's principle]]
[[!redirects Vopenka's principle]]
[[!redirects VopÄ›nkaâ€™s principle]]
[[!redirects Vopenkaâ€™s principle]]
[[!redirects VopÄ›nka s principle]]
[[!redirects Vopenka s principle]]
[[!redirects VopÄ›nka principle]]

[[!redirects VopÄ›nka's axiom]]
[[!redirects Vopenka's axiom]]
[[!redirects VopÄ›nkaâ€™s axiom]]
[[!redirects Vopenkaâ€™s axiom]]
[[!redirects VopÄ›nka s axiom]]
[[!redirects Vopenka s axiom]]
[[!redirects VopÄ›nka's axiom scheme]]
[[!redirects Vopenka's axiom scheme]]
[[!redirects VopÄ›nkaâ€™s axiom scheme]]
[[!redirects Vopenkaâ€™s axiom scheme]]
[[!redirects VopÄ›nka s axiom scheme]]
[[!redirects Vopenka s axiom scheme]]
[[!redirects VopÄ›nka's axiom schema]]
[[!redirects Vopenka's axiom schema]]
[[!redirects VopÄ›nkaâ€™s axiom schema]]
[[!redirects Vopenkaâ€™s axiom schema]]
[[!redirects VopÄ›nka s axiom schema]]
[[!redirects Vopenka s axiom schema]]

[[!redirects VopÄ›nka cardinal]]
[[!redirects VopÄ›nka cardinals]]
