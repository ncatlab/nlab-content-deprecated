...
In [[intensional type theory|intensional]] ([[Martin-LÃ¶f type theory|Martin-LÃ¶f]]) [[dependent type theory]] the existence of [[identity types]] induces a notion on [[path space objects|paths]] between [[terms]] of a given type.
...
Notice that every [[presentable (âˆž,1)-category|presentable]] [[locally Cartesian closed (âˆž,1)-category]] (by the discussion <a href="locally+cartesian+closed+(infinity,1)-category#PresentationTheorem">there</a>) has a presentation by a [[right proper model category|right proper]] [[Cisinski model category]]. Accordingly we may say that every [[presentable (âˆž,1)-category|presentable]] [[locally Cartesian closed (âˆž,1)-category]] interprets [[HoTT]]+FunExt.
...
* [[Richard Garner]], _On the strength of dependent products in the type theory of Martin-LÃ¶f_
