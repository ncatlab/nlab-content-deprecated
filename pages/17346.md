...
First we set up the general theory of $E$-[[Adams spectral sequences]]. (We consider examples and applications further [below](#ExamplesOfAdamsSpectralSequences).)
...
([Bousfield 79, Â§1](#Bousfield79)) see also for instance ([Lurie, Lecture 20, example 4](#Lurie10))
...
We now consider examples applying the general theory of $E$-[[Adams spectral sequences]] [above](#TheoryforAdamsSpectralSequences) in special cases to the concrete computation of certain stable homotopy groups.
...
whose product is subject to the following relations (called the **Ãdem relations**):
