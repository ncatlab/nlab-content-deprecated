...
[[chain complex|Chain complexes]] in non-negative degree in an [[abelian category]] $A$ are special in that they may be identified via the [[Doldâ€“Kan correspondence]] as [[simplicial object]]s in $A$.
...
At least if $A$ is the category of [[abelian groups]], so that $A^{\Delta^{op}}$ is the category of abelian [[simplicial group]]s it inherits naturally a model category structure from the [[model structure on simplicial sets]], which [[presentable (âˆž,1)-category|presents]] the [[(âˆž,1)-category]] of [[âˆž-groupoid]]s.
...
With due care this descends to the [[local model structure on simplicial presheaves]] which [[presentable (infinity,1)-category|presents]] the [[(âˆž,1)-sheaf (âˆž,1)-topos]] on $C$. Then the above Quillen adjunction serves to embed [[abelian sheaf cohomology]] on $C$ into the larger context of [[nonabelian cohomology]] on $C$. See [[cohomology]] for more on this.
...
* [[Herman Stel]], _[[schreiber:master thesis Stel|âˆž-Stacks and their Function Algebras -- with Applications to âˆž-Lie Theory]]_ (2010)
{#Stel}

The resolution model structures on cofibrant objects go back to

* [[William Dwyer]], [[Dan Kan]], C. Stover, _An $E_2$ model category structure for pointed simplicial spaces_, J. Pure and Applied Algebra 90 (1993) 137â€“152
{#DwyerKanStover}
...
* [[Denis-Charles Cisinski]], F. DÃ©glise, _Local and stable homologial algebra in Grothendieck abelian categories_, Homology, Homotopy and Applications, vol. 11 (1) (2009)  ([url](http://www.intlpress.com/HHA/v11/n1/a11/))
{#CisinskiDeglise}
