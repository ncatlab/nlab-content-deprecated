...
An [[(âˆž,1)-topos]] is **$n$-localic** if 

* regarded as a [[little topos]] it behaves like a generalized [[n-groupoid]]; 

* it behaves like the [[(âˆž,1)-category of (âˆž,1)-sheaves]] over an [[(âˆž,1)-site]] that is a [[(n,1)-category]].

More precisely: if [[(âˆž,1)-geometric morphisms]] into it are fixed by their restriction to the underlying [[(n,1)-toposes]] of [[n-truncated object of an (infinity,1)-category|(n-1)-truncated objects]].
...
of a given [[(âˆž,1)-topos]] $\mathcal{X}$ corresponds a tower of $n$-localic toposes $\mathcal{X}_n$ such that $\tau_{\leq n -1} \mathcal{X} \simeq \tau_{\leq n-1} \mathcal{X}_n$. We may think of the $n$-localic $\mathcal{X}_n$ as being $n$th stage in the [[Postnikov tower]] decomposition of $\mathcal{X}$.
...
We write [[(âˆž,1)Topos]] for the [[(âˆž,1)-category]] of [[(âˆž,1)-toposes]] and [[(âˆž,1)-geometric morphisms]] between them.

For $\mathcal{X}$ an [[(âˆž,1)-topos]] we denote by
...
An [[(âˆž,1)-topos]] $\mathcal{X}$ is **$n$-localic** if for any other
...
is an [[equivalence of (âˆž,1)-categories]] (of [[âˆž-groupoids]]).
...
The [[(âˆž,1)-category of (âˆž,1)-sheaves]] over an [[(âˆž,1)-site]] $C$ with finite limits which is an [[(n,1)-category]] is $n$-localic.
...
For $n \in \mathbb{N}$ and $\mathcal{X}$ an $n$-localic $(\infty,1)$-topos, the [[over-(âˆž,1)-topos]] $\mathcal{X}/U$ is $n$-localic precisely if the object $U$ is $n$-[[truncated]].
...
1. the restriction of the [[inverse image]] $U^* : \mathcal{X} \to \mathcal{X}/U$ (of the [[etale geometric morphism ]] from the [[over-(âˆž,1)-topos]]) to $(n-1)$-[[truncated]] objects is an [[equivalence of (âˆž,1)-categories]];
...
Let $\mathcal{G}$ be a [[geometry (for structured (âˆž,1)-toposes)]].

+-- {: .num_prop}
###### Proposition

If $\mathcal{G}$ is an [[(âˆž,n)-category]] then a $n$-localic $\mathcal{G}$-[[structured (âˆž,1)-topos]] is an $n$-[[truncated]] object in the [[(âˆž,1)-category]] $Topos(\mathcal{G})$.
...
[[!redirects localic (âˆž,1)-topos]]
[[!redirects localic (infinity,1)-topos]]

[[!redirects n-localic (âˆž,1)-topos]]
