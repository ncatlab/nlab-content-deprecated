...
The RaÅ¡evskii [[hyper-envelope of a Lie algebra]] $L$ is a completion of $U(L)$ by means of a countable family of norms $\hat{f}\mapsto \|\hat{f}\|_{\epsilon}$ for all $\epsilon$ in an arbitrary fixed family of positive numbers having $0$ as  an accumulation points, where
...
It is nontrivial and proved by RaÅ¡evskii that the algebra multiplication in $U(L)$ is continuous in this topology and hence that the completion of the $U(L)$ as a countably normed vector space carries the unique structure of a topological algebra extending the algebra operations on $U(L)$.  

* P. K. RaÅ¡evskii, _Associative hyper-envelopes of Lie algebras, their regular representations and ideals_, Trudy Mosk. Mat. Ob.

It may be tried to use the same definition with $e$ replaced by another coalgebra isomorphism $S(L)\to U(L)$. 

Remark: It is announced (by author of these lines [[Zoran Å koda|ZÅ ]], June 11, 2011), that under mild conditions this modified definition results in the isomorphic completion of $U(L)$ as a topological algebra. 


There is also an non-Archimedean version of the notion in the literature. 

[[!redirects hyperenvelope of a Lie algebra]]
