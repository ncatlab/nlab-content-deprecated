...
__Shelahâ€™s categoricity conjecture.__ Let $T$ be a countable theory in $L_{\omega_1,\omega}$ (cf. [[infinitary logic]]). If there exists $\lambda\geq\beth_{\omega_1}$ such that the number of isomorphism classes of models in cardinality $\lambda$ is $I(\lambda,T) = 1$ then $I(\mu,T) = 1$ holds for every
