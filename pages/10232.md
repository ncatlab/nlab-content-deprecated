...
Let $\mathbf{H}$ be a [[topos]] (for instance $\mathbf{H} =$[[SmoothSet]]) or [[(âˆž,1)-topos]] (for instance $\mathbf{H} = $ [[SmoothâˆžGrpd]]) and consider 
...
a [[bundle]] in $\mathbf{H}$, regarded as an object in the [[slice topos]]/[[slice (âˆž,1)-topos]].
...
[[!redirects âˆž-groupoid of sections]]
[[!redirects âˆž-groupoids of sections]]
