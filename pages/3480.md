...
* [[AndrÃ© Joyal]], [[Ross Street]], _An introduction to Tannaka duality and quantum groups_, [pdf](http://www.math.mq.edu.au/~street/CT90Como.pdf)

([proposition 5, page 40](http://www.maths.mq.edu.au/~street/CT90Como.pdf#page=40))

and

* [[Pierre Deligne]], _[[CatÃ©gories Tannakiennes]]_
...
This is notably the case for [[(âˆž,1)-category]] theory, where we have the [[(âˆž,1)-Yoneda lemma]].

#### For permutation $\infty$-representations
 {#ForInfinityPermutations}

By applying the $(\infty,1)$-Yoneda lemma verbatim four times in a row as above [for permutation representations](#ForPermutationRepresentations), we obtain the following statement for [[âˆž-permutation representations]].

+-- {: .num_theorem}
###### Theorem
**(Tannaka duality for $\infty$-permutation representations)**

Let $G$ be an [[âˆž-group]] and $Rep_{\infty Grpd}(G) := Func(\mathbf{B}G, \infty Grpd)$ the [[category of representations|category of]] [[âˆž-permutation representations]], the [[(âˆž,1)-category of (âˆž,1)-functors]] from its [[delooping]] [[âˆž-groupoid]] to [[âˆžGrpd]]. Let $F :  Rep_{\infty Grpd}(G) \to \infty Grpd$ be the fiber functor that remembers the underlying $\infty$-groupoid. Then there is an [[equivalence in a quasi-category]]
...
As before, this holds immediately even for representations of [[(âˆž,1)-categories]]
...
Let $c$ be an [[(âˆž,1)-category]] and $Rep_{\infty Grpd}(C) := Func(C,\infty Grpd)$. For $c \in C$ an [[object]], write $F_c : Rep_{\infty Grpd}(C) \to \infty Grpd$ for the corresponding fiber functor.
...
As a special case of this, we obtain a statement about $\infty$-Galois theory. For details and background see [[homotopy groups in an (âˆž,1)-topos]]. In that context one finds for a [[locally contractible space]] $X$ that the [[âˆž-groupoid]] $LConst(X)$ of [[locally constant âˆž-stack]]s on $X$  is equivalent to $Rep_{\infty Grpd}(\Pi(X))$, where $\Pi(X)$ is the [[fundamental âˆž-groupoid]] of $X$. 
...
More on this is at [[cohesive (âˆž,1)-topos -- structures]] in the section <a href="http://ncatlab.org/nlab/show/cohesive+%28infinity%2C1%29-topos+--+structures#Homotopy">Galois theory in a cohesive (âˆž,1)-topos</a>
...
* [[Alexander Rosenberg|Alexander L. Rosenberg]],  _The existence of fiber functors_,  The Gelfand Mathematical Seminars, 1996--1999,  145--154, BirkhÃ¤user, Boston 2000.

Deligne's proof in turn fills the gap in the seminal work with the same title 

* N. Saavedra Rivano, "CatÃ©gories Tannakiennes." _Bulletin de la SociÃ©tÃ© MathÃ©matique de France_ 100 (1972): 417-430. [EuDML](https://eudml.org/doc/87193)
...
* Phung Ho Hai, _Tannaka-Krein duality for Hopf algebroids_, Israel J. Math. __167__ (1):193â€“225 (2008) [math.QA/0206113](http://arxiv.org/abs/math/0206113)

* [[Volodymyr Lyubashenko|Volodymyr V. Lyubashenko]], _Squared Hopf algebras and reconstruction theorems_, Proc. Workshop â€œQuantum Groups and Quantum Spacesâ€ (Warszawa), Banach Center Publ. __40__, Inst. Math. Polish Acad. Sci. (1997) 111â€“137, [q-alg/9605035](http://arxiv.org/abs/q-alg/9605035); _Squared Hopf algebras_, Mem. Amer. Math. Soc. __142__ (677):x 180, 1999; ÐÐ»Ð³ÐµÐ±Ñ€Ñ‹ Ð¥Ð¾Ð¿Ñ„Ð° Ð¸ Ð²ÐµÐºÑ‚Ð¾Ñ€-ÑÐ¸Ð¼Ð¼ÐµÑ‚Ñ€Ð¸Ð¸, Ð£ÐœÐ, 41:5(251) (1986), 185â€“186, [pdf](http://www.mathnet.ru/php/getFT.phtml?jrnid=rm&paperid=2247&what=fullt&option_lang=rus), transl. as: _Hopf algebras and vector symmetries_, Russian Math. Surveys 41(5):153154, 1986.

* A. BruguiÃ¨res, _ThÃ©orie tannakienne non commutative_, Comm. Algebra __22__, 5817â€“5860, 1994
...
â€Galois theory, Hopf algebras, and semiabelian categoriesâ€, Fields Inst. Comm. __43__
(2004) 187-225 

* [[Daniel SchÃ¤ppi]], _The formal theory of Tannaka duality_, [arxiv/1112.5213](http://arxiv.org/abs/1112.5213), superseding earlier _Tannaka duality for comonoids in cosmoi_, [arXiv:0911.0977](http://arxiv.org/abs/0911.0977)
...
* [[Tadao Tannaka]], _Ãœber den DualitÃ¤tssatz der nichtkommutativen topologischen Gruppen_, Tohoku Math. J. 45 (1938), n. 1, 1â€“12 (project euclid has only Tohoku new series!), see [[Tannaka-Krein theorem]].
* N. Tatsuuma, _A duality theorem for locally compact groups_, J. Math., Kyoto Univ.
6 (1967), 187â€“293.
* M.G. Krein, _A principle of duality for bicompact groups and quadratic block algebras_, Doklady AN SSSR __69__ (1949), 725â€“728. 
* Eiichi Abe, _DualitÃ© de Tannaka des groupes algÃ©briques_, Tohoku Mathematical Journal. Volume 12, Number 2  (1960), 327-332. 

The Tannaka-type reconstruction in quantum field theory see [[Doplicher-Roberts reconstruction theorem]].

Tannaka duality in the context of [[(âˆž,1)-category theory]] is discussed in
