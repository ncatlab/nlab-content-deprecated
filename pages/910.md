...
Sometimes $k$-spaces are called __Kelley spaces__, after [[John Kelley]], who studied them extensively; however, they predate him and the â€˜$k$â€™ does not stand for his name.  (Probably it has something to do with 'compact' or 'kompakt'.)
...
Since the topology is determined by convergent sequences = maps from one-point [[compactification]] $\mathbb{N} \cup \{\infty\}$); these include all Fr&eacute;chet spaces.
