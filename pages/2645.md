...
But the notion of [[nLab:invariant polynomial]]s and [[nLab:Chern-Simons element]]s naturally exists much more generally for [[nLab:L-âˆž algebra]]s, and even more generally for [[nLab:L-âˆž algebroid]]s. We claim here that in this fully general case there is still a natural analog of the Chern-Weil homomorphism -- which we call the _[[nLab:âˆž-Chern-Weil homomorphism]]_ . Accordingly this gives rise to a wide class of [[nLab:action functional]]s for [[nLab:gauge theory|gauge]] [[nLab:quantum field theories]], which may be called _[[schreiber:âˆž-Chern-Simons theories]_.
...
The notions of [[Lie group]], [[Lie algebra]], [[principal bundle]] and all the other ingredients of ordinary Chern-Weil theory generalize to notions in [[higher category theory]] such as  [[âˆž-Lie group]], [[âˆž-Lie algebra]], [[principal âˆž-bundle]] etc. The generalization of Chern-Weil theory to this context is discussed at 
...
* [[Eli Cartan]], _La topologie des espaces reprÃ©sentatifs des groupes de Lie_ Act. Sci. Ind., No. 358, Hermann, Paris, (1936).
...
* [[Heinz Hopf]],  _Ãœber die Topologie der Gruppen-Mannigfaltigkeiten und ihre Verallgemeinerungen_  (German)  Ann. of Math. (2)  42,  (1941). 22--52.
...
* [[Henri Cartan]], _Notions d'algÃ©bre diffÃ©rentielle; applications aux groupes de Lie et aux variÃ©tÃ©s oÃ¹ opÃ¨re un groupe de Lie_ ,  Coll. Topologie AlgÃ©brique Bruxelles (1950)
15-28
...
* [[Mikhail Postnikov|Ðœ. Ðœ. ÐŸÐ¾ÑÑ‚Ð½Ð¸ÐºÐ¾Ð²]], _Ð›ÐµÐºÑ†Ð¸Ð¸ Ð¿Ð¾ Ð³ÐµÐ¾Ð¼ÐµÑ‚Ñ€Ð¸Ð¸. Ð¡ÐµÐ¼ÐµÑÑ‚Ñ€ 4, Ð”Ð¸Ñ„Ñ„ÐµÑ€ÐµÐ½Ñ†Ð¸Ð°Ð»ÑŒÐ½Ð°Ñ Ð³ÐµÐ¾Ð¼ÐµÑ‚Ñ€Ð¸Ñ_ â€” Ðœ.: ÐÐ°ÑƒÐºÐ°, 1988	
