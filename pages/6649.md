...
Let $V$ be a [[B̩nabou cosmos]], and let $\mathcal{X}$ be a [[class]] of $V$-functors $\Phi\colon D\to V$ where $D$ is a [[small category|small]] $V$-category.  Note that the domain $D$ may be different for different elements of $\mathcal{X}$.
...
* [[Max Kelly]] and [[Robert Par̩]], "A note on the Albert-Kelly paper 'The closure of a class of limits'", JPAA 51 (1988), 19--25
 {#KP}
