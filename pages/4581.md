...
* $\mathbf{H}_{/\Sigma}
    ...
    \mathbf{H}$ 
  for the [[base change]] [[adjoint triple]] over $\Sigma$, the [[Ã©tale geometric morphism]] of the [[slice (infinity,1)-topos]] $\mathbf{H}_{/\Sigma}$; 
...
* [[Alexandre Vinogradov]], _A spectral sequence associated with a non-linear differential equation, and the algebro-geometric foundations of Lagrangian field theory with constraints_ , Sov. Math. Dokl. 19 (1978) 144â€“148.

* W. M. Tulczyjew, _The Euler-Lagrange resolution_ , in Lecture Notes in Mathematics 836 22â€“48 (Springer-Verlag, New York 1980).

* T. Tsujishita, _On variation bicomplexes associated to differential equations_, Osaka J. Math. 19 (1982), 311â€“363.
...
* [[Ian Anderson]], _Introduction to the variational bicomplex_ in Mathematical aspects of classical field theory, Contemp. Math. 132 (1992) 51â€“73, [gBooks](http://books.google.com/books?id=NuiJ0c72_gQC&lpg=PA51&ots=-zAVQLViUn&dq=Zuckerman%20variational%20problems)
