...
A _stable model category_ is a 1-[[category]] structure used to present a [[stable (âˆž,1)-category]] in analogy to how a general [[model category]] encodes a (generally non-stable) [[(âˆž,1)-category]].
