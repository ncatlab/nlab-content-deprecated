...
### Ã‰tale homotopy type

+-- {: .num_example}
###### Example

For $k$ a [[field]] of [[characteristic]] 0, then the affine line $\mathbb{A}^1_k$ has a [[contractible homotopy type|contractible]] [[Ã©tale homotopy type]] . This is no longer the case in [[positive number|positive]] [[characteristic]].
...
Since the internal logic is local, we can assume that $X = Spec(R)$ is affine. The interpretations of the asserted statements using the [[Zariski site#KripkeJoyal|Kripkeâ€“Joyal semantics]] are:
...
In [[A1-homotopy theory|A^1 homotopy theory]] one considers the [[reflective sub-(âˆž,1)-category|reflective]] [[localization of an (âˆž,1)-category|localizatoin]]
...
of the [[(âˆž,1)-topos]] of [[(âˆž,1)-sheaves]] over a [[site]] $C$ such as the [[Nisnevich site]], at the morphisms of the form
...
Discussion of [[Ã©tale homotopy type]] is in
