...
The following is a version of the above general statement restricted to a [[strict âˆž-groupoid]]-version of the [[fundamental âˆž-groupoid]] and applicable for [[topological spaces]] that are equipped with the extra structure  of a [[filtered topological space]].
...
In a [[cohesive (âˆž,1)-topos]] (already in a [[locally âˆž-connected (âˆž,1)-topos]]) higher van Kampen theorems hold in great generality. 
