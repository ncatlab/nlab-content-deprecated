...
An explicit proof, involving many diagrams, has been written up by [[Igor BakoviÄ‡]] and can be found [here](http://www.irb.hr/korisnici/ibakovic/yoneda.pdf).
...
First, there is a 2-monad $T$ such that strict $T$-algebras are strict 2-categories, strict $T$-morphisms are strict 2-functors, pseudo $T$-algebras are [[unbiased bicategory|unbiased bicategories]], and pseudo $T$-morphisms are [[pseudofunctors]].  By Mac Lane's coherence theorem for bicategories, any ordinary bicategory can equally well be considered as an unbiased one.  Thus, since $Cat$ is a strict 2-category, for any bicategory $C$ there is a strict 2-category $C'$ such that pseudofunctors $C\to Cat$ are in bijection with strict 2-functors $C'\to Cat$.
