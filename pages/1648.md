...
* The â€œeverywhereâ€ follows from the arbitrary path taken to carry a state. 

* â€œSymmetricâ€ follows that both left and right are similar definitions, but they are different because of the direction to where tha natural functor maps. 
