...
In fact, this is true of any [[separable space|separable metrizable space]]. Note that mere separability does not suffice, as there are separable spaces that are not first-countable, such as the Stone-ÄŒech compactification of $\N$, and hence cannot be subspaces of any metrizable space. What distinguishes Polish spaces is that they are, up to homeomorphism, precisely the _$G_\delta$ subsets_ of the Hilbert cube. 
...
* [Polish spaces](http://golem.ph.utexas.edu/category/2008/08/polish_spaces.html), blog discussion, $n$-category cafÃ©, 2008-
