...
Generally, an **$\infty$-species** or **homotopical species** is an [[(âˆž,1)-presheaf]] on $core(FinSet)$, i.e. an [[(âˆž,1)-functor]]

$$
  core(FinSet)^{op} \to \infty Grpd
$$

to the [[(âˆž,1)-category]] [[âˆžGrpd]].

The [[(âˆž,1)-category]] of $\infty$-species is the [[(âˆž,1)-category of (âˆž,1)-presheaves]]
...
every (tame) [[âˆž-groupoid]] is mapped to a [[real number]]
...
A species $\mathbf{X}$ assigns an [[âˆž-groupoid]] $\mathbf{X}_n$ to each [[natural number]] $n \in \mathbb{Z}$. Therefore under [[groupoid cardinality]] we may naturally think of a tame species as mapping to a [[power series]]
...
* {#Joyal81} [[AndrÃ© Joyal]], _Une thÃ©orie combinatoire des sÃ©ries formelles_ , Advances in Mathematics 42:1-82 (1981) <a href="http://dx.doi.org/10.1016/0001-8708(81)90052-9">doi</a>, [MR84d:05025](http://www.ams.org/mathscinet-getitem?mr=633783)
...
* FranÃ§ois Bergeron, Gilbert Labelle, Pierre Leroux, _ThÃ©orie des espÃ¨ces et combinatoire des structures arborescentes_ , LaCIM, MontrÃ©al (1994). English version: [[Combinatorial species and tree-like structures]], Cambridge University Press (1998).
...
* FranÃ§ois Bergeron, _Species and variations on the theme of species_, invited talk at [Category Theory and Computer Science '04](http://www.itu.dk/research/theory/ctcs2004/), Copenhagen (2004). Slides ([pdf](http://bergeron.math.uqam.ca/Especes_trans.pdf)).
...
* {#AguiarMahajan10} [[Marcelo Aguiar]], [[Swapneel Mahajan]], _[[Monoidal Functors, Species and Hopf Algebras]]_, With forewords by [[Kenneth Brown]], [[Stephen Chase]], [[AndrÃ© Joyal]]. CRM Monograph Series __29__ Amer. Math. Soc. 2010. lii+784 pp. ([pdf draft](http://www.math.tamu.edu/~maguiar/a.pdf))
...
* W. Faris, _Combinatorial species and cluster expansions_, Mosc. Math. J. __10__:4 (2010), 713â€“727 [pdf](http://www.ams.org/distribution/mmj/vol10-4-2010/faris.pdf), [MR2791054](http://www.ams.org/mathscinet-getitem?mr=2791054)

Discussion in relation to [[Feynman diagrams]]:

* {#Baez01} [[John Baez]] and [[James Dolan]], From finite sets to Feynman diagrams, in _Mathematics Unlimited - 2001 and Beyond_, vol. 1, eds. BjÃ¶rn Engquist and Wilfried Schmid, Springer, Berlin, 2001, pp. 29-50.  ([arXiv](http://arxiv.org/abs/math.QA/0004133))
