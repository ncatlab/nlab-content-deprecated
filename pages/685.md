...
These are then a special case of the more general [[(âˆž,1)-limit]]s and [[(âˆž,1)-colimit]]s in a [[(âˆž,1)-category]]. A [[(2,1)-category]] is a special case of an [[(âˆž,1)-category]].

Traditionally, [[(âˆž,1)-limit]]s are best known in tersm of the presentation of $(\infty,1)$-catgeories by [[categories with weak equivalences]] in general and [[model categories]] in particular.  (2,1)-limits can often also be viewed in this way.  The corresponding presentation of the $(\infty,1)$-limits / $(2,1)$-limits is called **[[homotopy limit]]s** and **[[homotopy colimit]]s**.

For instance 2-limits in the [[(2,1)-category]] [[Grpd]] of [[groupoid]]s, [[functor]]s and (necessarily) [[natural isomorphism]]s. Are equivalently computed as [[homotopy limit]]s in the [[model structure on simplicial sets]] $sSet_{Quillen}$ of diagrams of [[1-truncated]] [[Kan complex]]es. (The equivalnce of homotopy limits with $(\infty,1)$-limits is discusssed at [[(âˆž,1)-limit]]).
...
* [[Ross Street]], _Fibrations in Bicategories_, Cahiers de Topologie et GÃ©omÃ©trie DiffÃ©rentielle CatÃ©goriques, Volume **21** (1980) no. 2, pp 111-160.  [Numdam](http://www.numdam.org/item?id=CTGDC_1980__21_2_111_0 ) and correction, Cahiers de Topologie et GÃ©omÃ©trie DiffÃ©rentielle CatÃ©goriques, Volume **28** (1987) no. 1, pp 53-56 [Numdam](http://www.numdam.org/item?id=CTGDC_1987__28_1_53_0 )
