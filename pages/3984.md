...
# Tangential Topics of Fr&ouml;licher Spaces
{#tangent}
...
An advantage of the dual nature of the definition of a [[Fr̦licher space]] is that just about every definition of a tangent or cotangent vector is possible.
Essentially, as we have access to both [[curves]] and [[functionals]] we can consider [[push-forward]]s and [[pull-back]]s.

The ideas in this section can be traced at least as far back as Fr̦licher's work in [MR842916](http://www.ams.org/mathscinet-getitem?mr=842916).
...
+-- {: mynumdef #FlatFun}
###### Definition
 Let $(X, \mathcal{C}, \mathcal{F})$ be a Fr̦licher space, $x \in X$.
...
[[!redirects tangential notions of Fr̦licher spaces]]
