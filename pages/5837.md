...
For instance this is the [[automorphism âˆž-group]] of a manifold, regarded as a [[k-morphism]] in an [[(âˆž,n)-category of cobordisms]].
...
For $\Sigma$ a [[closed manifold|closed]] [[orientation|orientable]] [[surface]], then the [[fundamental âˆž-groupoid|bare homotopy type]] of its diffeomorphism group is
...
* {#Cerf} J. Cerf, _Sur les diffÃ©omorphismes de la sphÃ¨re de dimension trois ($\Gamma_4 = 0$)_, Lecture Notes in Math., vol. 53, Springer-Verlag, Berlin and New York, 1968_
