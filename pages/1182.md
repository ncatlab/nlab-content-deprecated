...
This entry is about the work by David Ben-Zvi, John Francis and David Nadler on application of a [[(infinity,1)-category|(âˆž,1)-categorical]] realization of [[geometric function theory]] to [[FQFT|extended quantum field theory]] in the context in which Jacob Lurie proved the [[generalized tangle hypothesis|cobordism hypothesis]].
...
This entry is supposed to be the $n$Lab-working area for a " Journal Club -- Geometric $\infty$-function theory ". The corresponding discussion page at the $n$-Caf&eacute; is [Journal Club -- Geometric âˆž-Function Theory](http://golem.ph.utexas.edu/category/2009/04/journal_club_geometric_infinit.html)
...
Geometric $\infty$-function theory is about the [[âˆž-categorification]] of the following basic fact of [[matrix calculus]]: for $X$ and $Y$ finite sets, for $k$ a field and for $C(X)$ and $C(Y)$ the $k$-vector spaces of $k$-valued functions on $X$ and $Y$, respectively, we have natural isomorphisms
...
* Monday, April 27: [[Alex Hoffnung|Alex]] on section 1, [Introduction](http://arxiv.org/PS_cache/arxiv/pdf/0805/0805.0157v4.pdf#page=2) [[tick6.png:pic]] ([n-category cafÃ© entry](http://golem.ph.utexas.edu/category/2009/04/journal_club_geometric_infinit_1.html))

* Monday, May 4: [[Urs Schreiber|Urs]] on section 2, [Preliminaries](http://arxiv.org/PS_cache/arxiv/pdf/0805/0805.0157v4.pdf#page=10) [[tick6.png:pic]] ([n-category cafÃ© entry](http://golem.ph.utexas.edu/category/2009/05/journal_club_geometric_infinit_2.html))

* Monday, May 11: [[Bruce Bartlett|Bruce]] on section 3, [Perfect Stacks](http://arxiv.org/PS_cache/arxiv/pdf/0805/0805.0157v4.pdf#page=16) [[tick6.png:pic]] ([n-category cafÃ© entry](http://golem.ph.utexas.edu/category/2009/05/journal_club_geometric_infinit_3.html))

* Monday, May 18: [[Chris Brav|Christopher]] on section 4, [Tensor products and integral transforms](http://arxiv.org/PS_cache/arxiv/pdf/0805/0805.0157v4.pdf#page=24) [[tick6.png:pic]]  ([n-category cafÃ© entry](http://golem.ph.utexas.edu/category/2009/05/journal_club_geometric_infinit_4.html))
...
The central structural theorem of [[FQFT|TQFT]], the [[generalized tangle hypothesis|cobordism theorem]] states that [[FQFT|(âˆž,n)-categorical extended topological quantum field theories]] are entirely determined by their value in the [[point]], which has to be an [[object]] in an [[(âˆž,n)-category]] with high dualizability properties.
...
The central tool, from which this entry draws its title, is an [[(infinity,1)-category|(âˆž,1)-categorical]] version of [[geometric function theory]]: 
...
This picture arises  naturally and is maybe best understood in terms of [[FQFTs]] that arise as [[Ïƒ-models]], namely which are [[representable functor|represented]] by a _target space_ object $P$:

assume that $P$ is some kind of generalized space (which will usually mean: an [[(âˆž,1)-sheaf]], see [[motivation for sheaves, cohomology and higher stacks]] for motivation of this point) and regard the manifolds $\Sigma$ as special cases of generalized manifolds.
...
If now $C([\Sigma_{in},P])$ denotes some sensible collection of $\infty$-functions on the mapping space $[\Sigma_{in}, P]$, there will be an [[(infinity,1)-category|âˆž-categorical]] pull-push operation
...
* such that interesting classes of [[Ïƒ-model]] [[FQFT|extended TQFTs]] $Z_P$ are [[representable functor|represented]] by [[motivation for sheaves, cohomology and higher stacks|generalized spaces]] $P$ 
...
* [[Higher Topos Theory]] -- the theory of [[(âˆž,1)-categories]] and [[(âˆž,1)-sheaves]]
  ...
  * this assembles and develops 
    ...
    * work by [[BrownAHT|Brown]], [[Andre Joyal|Joyal]], Jardine and others on [[presentable (infinity,1)-category|models]] for [[âˆž-stacks]] in terms of a [[model structure on simplicial presheaves]].
...
* [[Stable Infinity-Categories|Stable Higher Category Theory]] -- essentially the theory of [[additive and abelian categories]] lifted to the $(\infty,1)$-context;
  ...
  * which puts the large body of work on [[homotopy theory|stable homotopy theory]] and [[homological algebra]] into the above [[(infinity,1)-category|(âˆž,1)-categorical]] context, in essence identifying the abstract idea modeled by [[pretriangulated dg-category|pretriangulated dg-categories]] and $A_\infty$-[[A-âˆž-categories|categories]]

* [[higher algebra|Higher Algebra]] -- the theory of [[monoid]]- or [[algebra]]-objects [[internalization|internal to]] ([[symmetric monoidal (infinity,1)-category|symmetric]]) [[monoidal (infinity,1)-category|monoidal]] [[(infinity,1)-category|(âˆž,1)-categories]]
  ...
  * which puts into its natural higher categorical context
    ...
    * the notions of things like [[Aâˆž-rings]] and [[symmetric monoidal category|Eâˆž-category]].
...
* the concept of an [[(âˆž,1)-sheaf]]/[[âˆž-stack]] is _much simpler_ than its model in terms of the [[model structure on simplicial presheaves]];

* the concept of a [[stable (âˆž,1)-category]] is _much simpler_ than its 1-categorical shadow as a [[triangulated category]];

* the concept of a [[commutative algebra in an (âˆž,1)-category]] is _simpler_ than the details of its realization given by a [[commutative ring spectrum]].
...
The [[âˆž-categories]] that we are dealing with here are 

* [[(âˆž,1)-categories]].

There are several reasons for 

* [[Why (âˆž,1)-categories?]]
...
* [[presentable (infinity,1)-category|presentation of an (âˆž,1)-category]].
...
In order to formulate this, one needs a good general theory of [[higher algebra]]. Just as ordinary [[algebra]] takes place inside a [[monoidal category]], [[higher algebra]] takes place in a [[monoidal (âˆž,1)-category]]:

an â€œ$\infty$-monoid" or â€œ$\infty$-algebra" (to distinguish from the traditional [[Aâˆž algebra]], which is supposedly a special case) is an [[algebra in an (infinity,1)-category|algebra/monoid object in a monoidal (âˆž,1)-category]].

In order to characterize the $(\infty,1)$-categories $C(X)$ as algebra objects in such a sense we profit from the ease with which [[quasi-category|quasi-categories]] naturally reflect on themselves and allow us with comparative ease to talk about the [[(âˆž,1)-category of (âˆž,1)-categories]] $(\infty,1)Cat_1$.

Since $(\infty,1)Cat_1$ itself is a [[symmetric monoidal (âˆž,1)-category]], we will essentially identify the $\infty$-algebras $C(X)$ as [[algebra in an (infinity,1)-category|algebra objects]] in $(\infty,1)Cat_1$.

But there is actually a slight technical simplification: we don't deal with _all_ $(\infty,1)$-categories, but just with [[presentable (âˆž,1)-categories]]. See there for the (long) list of nice properties and characterization of presentable $(\infty,1)$-categories.

So

* presentable $(\infty,1)$-categories form the [[symmetric monoidal (âˆž,1)-category of presentable (âˆž,1)-categories]]  $Pr(\infty,1)Cat_1^L$;

* the $\infty$-algebras of $\infty$-functions $C(X)$ are [[algebra in an (infinity,1)-category|algebra objects in]] $Pr(\infty,1)Cat_1^L$.

Notice that this means in particular that the "additive" structure on $C(X)$ is taken to be nothing but the $(\infty,1)$-categorical colimit operation inside $C(X)$: this is the operation with respect to which [[(âˆž,1)-functors]] in $(\infty,1)Cat_1^L$ are linear, and with respect to which the tensor product is bilinear.
...
For $X \to Y \leftarrow X'$ morphisms of nice generalized spaces ([[perfect âˆž-stacks]]) and for $\infty$-functions $C(-) = QC(-)$ (given by the assignment of $(\infty,1)$-categories of quasicoherent sheaves) we have
...
The following discussion aims to describe the role played by [[âˆž-stacks]] and their morphisms in the context of geometric $\infty$-funcion theory. 

We place ourselves in the context of an [[(âˆž,1)-category]]
$H$ of (possibly [[derived stack|derived]]) $\infty$-stacks, i.e. of [[(âˆž,1)-sheaves]].
...
* the first datum is: $S$ a [[small category|small (âˆž,1)-category]];

* let then $PSh(S) := Funct(S^{op}, \infty\text{-}Grpd)$ be the $(\infty,1)$-category
of [[(âˆž,1)-functors]] from the [[opposite (infinity,1)-category|opposite (âˆž,1)-category]] $S^{op}$
to the $(\infty,1)$-category of $\infty$-groupoids.

* the second datum is: $i : H \hookrightarrow PSh(S)$ a 
[[full (infinity,1)-subcategory|full (âˆž,1)-subcategory]] of $PSh(S)$
such that the inclusion is a [[geometric morphism]] of  
[[(âˆž,1)-topoi]], i.e. such that $i$ has
a [[exact (infinity,1)-functor|left exact]] [[adjoint (infinity,1)-functor|left adjoint]]
$(-)^* : PSh(S) \to H$.

The same in one sentence: $H$ is a sub-[[(âˆž,1)-topos]] of the [[(âˆž,1)-topos]]
of [[(âˆž,1)-presheaves]] on $S$.

Or equivalently: $H$ is an [[(âˆž,1)-category of (âˆž,1)-sheaves]] on $S$.


Now the fairly explicit way:

There are various different but equivalent explicit realizations, or models,
for [[(âˆž,1)-categories]]. 
...
To get back to our [[(âˆž,1)-category of (âˆž,1)-sheaves]] $H$,
...
[[(âˆž,1)-sheafification]]: it sends every [[(âˆž,1)-presheaf]]
to the corresponding [[(âˆž,1)-sheaf]]. In other words, this is
...
This is notably relevant for the [[fundamental âˆž-groupoid]]:
...
Morphisms from the [[fundamental âˆž-groupoid]] are also called [[local systems]].
...
_geometric $\infty$_-function theory is the behaviour of $\infty$-functions on [[loop space object|loop spaces]]. The $(\infty,1)$-category $C(\Lambda X)$ of $\infty$-functions on the free loop space $\Lambda X$ of a sufficiently nice generalized space (a _perfect_ [[âˆž-stack]]) $X$ turns out to be the  [[infinity-trace|âˆž-trace]] or [[infinity-center|âˆž-center]] of that of $X$
...
which in turn are identified with the $\infty$-version of [[infinity-Hochschild homology|âˆž-Hochschild homology]] 

$$
  Tr(C(X)) := HH_*(C(X)) := C(X) \otimes_{C(X)\otimes C(X)^{op}} C(X)
$$ 

and [[infinity-Hochschild cohomology|âˆž-Hochschild cohomology]] 
...
Notice, by the way, that this phenomenon is the source of all "long exact sequences" that you'll ever run into: if we are for instance in a [[stable (âˆž,1)-category]], so that the [[terminal object]] $*$ is even a [[zero object]], $* = 0$, then a sequence
...
* [[monoidal (infinity,1)-category|1-fold monoidal (âˆž,1)-categories]];

* [[symmetric monoidal (infinity,1)-category|âˆž-tuply monoidal (âˆž,1)-categories]].
...
In [John Francis' PhD thesis](http://dspace.mit.edu/handle/1721.1/43792) (reference _EnAction_ below ) the theory of [[(âˆž,1)-categories]] equipped with an action of the $E_n$-[[operad]] is established, so that

* $(\infty,1)$-categories with an $E_1$-action are precisely [[monoidal (âˆž,1)-categories]]  -- 1-fold monoidal $(\infty,1)$-categories;

* $(\infty,1)$-categories with an $E_\infty$-action are precisely [[symmetric monoidal (âˆž,1)-categories]] -- $\infty$-tuply monoidal $(\infty,1)$-categories;
...
In this section of the paper, the notion of a  [[perfect âˆž-stack]] is defined, which is the general context in which the ideas of geometric $\infty$-function theory apply thoroughly without modifications.
...
[[higher algebra|Brave new algebra]] is about constructions in the [[stable (âˆž,1)-category of spectra]] $S_{\infty}$, which, like [[Ab]], is [[symmetric monoidal (infinity,1)-category|closed symmetric monoidal]] (under [[smash product of spectra]]) and [[cocomplete category|(co)]] [[complete category|complete]]. This means that we can consider [[algebra in an (infinity,1)-category|algebra objects]] $R$ and [[commutative algebra in an (infinity,1)-category|commutative algebra objects]] $A$ in $S_{\infty}$, as well as modules over them.
...
between two [[presentable (âˆž,1)-categories]] $C,D$
is $Fun^{L}(C,D)$, which consists of colimit preserving [[(âˆž,1)-functors]]. To construct it, one considers $C$ and $D$ as
[[quasi-categories]] or weak Kan complexes. Functors from $C$ to $D$ are just maps of [[simplicial sets]], so the [[(âˆž,1)-category of (âˆž,1)-functors]] from $C$ to $D$ is just
...
For the [[symmetric monoidal (infinity,1)-category of presentable (infinity,1)-categories|tensor product of presentable (âˆž,1)-categories]] we construct the $\infty$-category $C \otimes D$ which is
...
In section of 4.1 BZFN, there are various results, which are consequences of the [[Barr-Beck theorem|(âˆž,1)-categorical Barrâ€“Beck theorem]]. 
...
For the general [[(infinity,1)-category|(âˆž,1)-categorical]] formalism

* [[Jacob Lurie]], [[Higher Topos Theory]].

For the [[stable (infinity,1)-category|stable]] aspects

* [[Jacob Lurie]], [[Stable âˆž-Categories]].
...
[[!redirects geometric âˆž-function theory]]