...
* [[objects]] are [[finite type]] [[âˆž-Lie algebroid representations]] of $T_{hol} X$, hence [[cochain complexes]] of [[complex vector bundles]] $E^{\bullet}$ over $X$ equipped with a $\mathbb{C}$-linear map
...
* {#KoszulMalgrange58} [[Jean-Louis Koszul]], [[Bernard Malgrange]], _Sur certaine structures fibrÃ©es complexes_, arch. mat, vol IX, 1958
...
* {#Pali06} N. Pali, _Faisceaux $\bar \partial$-cohrents sur les variÃ©tÃ© complexes_ ( _$\bar \partial$-Coherent sheaves on complex manifolds) Math.
Ann. 336 (2006), no. 3, 571â€“615 ([arXiv:math/0305422](http://arxiv.org/abs/math/0305422))
...
* {#DelzantPy10} Thomas Delzant, Pierre Py, _KÃ¤hler groups, real hyperbolic spaces and the Cremona group_, Compositio Math. 148, no. 1 (2012), 153--184 ([arXiv:1012.1585](http://arxiv.org/abs/1012.1585))