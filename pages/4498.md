...
[[simplicial group|Simplicial groups]] model all [[âˆž-group]]s in [[âˆžGrpd]]. Accordingly  [[principal âˆž-bundle]]s in [[âˆžGrpd]] (a [[discrete âˆž-groupoid|discrete]] $\infty$-bundle) should be modeled by [[Kan complex]]es $E \to X$ equipped with a principal [[action]] by a [[simplicial group]]. It is suficient to assume the action to be strict. This yields the notion of _simplicial principal bundles_ .
...
in [[sSet]] exhibits $P_\bullet$ as the [[homotopy pullback]] in $sSet_{Quillen}$ / [[(âˆž,1)-pullback]] in [[âˆžGrpd]]
