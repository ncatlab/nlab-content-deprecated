...
An _$(\infty,1)$-cohesive site_ is a [[site]] such that the [[(âˆž,1)-category of (âˆž,1)-sheaves]] over it is a [[cohesive (âˆž,1)-topos]].
...
A [[site]] $C$ is **$\infty$-cohesive** over [[âˆžGrpd]] if it is

* a [[strongly âˆž-connected site]]

* and an [[âˆž-local site]].
...
* the category [[CartSp]] with covering families given by open covers $\{U_i \hookrightarrow U\}$ by [[geodesically convex|convex]] subsets $U_i$;
  ...
  * or [[smooth maps]]
    ...
    -- in which case the sheaf topos models generalized [[smooth space]]s such as [[diffeological space]]s, the [[(âˆž,1)-sheaf (âˆž,1)-topos]] is that of [[âˆž-Lie groupoid]]s;
...
More discussion of these two examples is at [[âˆž-Lie groupoid]] and [[âˆž-Lie algebroid]].
...
Let $C$ be an $\infty$-cohesive site. Then the [[(âˆž,1)-sheaf (âˆž,1)-topos]] $Sh_{(\infty,1)}(C)$ over $C$ is a [[cohesive (âˆž,1)-topos]] that satisfies the axiom "discrete objects are concrete" .
...
Since the [[(n,1)-topos]] over a site for any $n \in \mathbb{N}$ arises as the full [[sub-(âˆž,1)-category]] of the $(\infty,1)$-topos on the $n$-[[truncated]] objects and since the definition of cohesive $(n,1)$-topos is compatible with such truncation, it follows that
...
1. $Sh_{(\infty,1)}(C)$ is a [[locally âˆž-connected (âˆž,1)-topos]] and a [[âˆž-connected (âˆž,1)-topos]].

  This follows with the discussion at [[âˆž-connected site]].

1. $Sh_{(\infty,1)}(C)$ is a [[local (âˆž,1)-topos]]. 

   This follows with the discussion at [[âˆž-local site]].

1. The [[fundamental âˆž-groupoid in a locally âˆž-connected (âˆž,1)-topos]] $\Pi : Sh_{(\infty,1)}(C) \to \infty Grpd$ preserves finite [[(âˆž,1)-products]]. 
...
By the discussion at [[âˆž-connected site]] we have that $\Pi$ is given by the [[(âˆž,1)-colimit]] $\lim_\to : PSh_{(\infty,1)}(C) \to \infty Grpd$. By the assumption that $C$ is a [[cosifted (âˆž,1)-category]], it follows that this operation preserves finite products.
...
A [[cohesive (âˆž,1)-topos]] over an $\infty$-cohesive site satisfies [[Aufhebung]] of the [[unity of opposites|moments]] of [[becoming]]. See at _[[Aufhebung]]_ the section _[Aufhebung of becoming -- Over cohesive sites](http://ncatlab.org/nlab/show/Aufhebung#ExamplesBecomingFormalization)_.
...
[[!redirects âˆž-cohesive site]]
[[!redirects âˆž-cohesive sites]]

[[!redirects (infinity,1)-cohesive site]]


[[!redirects (âˆž,1)-cohesive site]]
