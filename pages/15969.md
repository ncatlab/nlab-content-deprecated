...
* {#Cis13} [[Denis-Charles Cisinski]], _Descente par Ã©clatements en K-thÃ©orie invariante par homotopie_, Ann. of Math. (2) 177 (2013), no. 2, pp. 425â€“448 ([pdf](http://hal.archives-ouvertes.fr/docs/00/52/56/40/PDF/descente3.pdf))

* {#NSO11} [[Niko Naumann]], [[Markus Spitzweck]], [[Paul Arne Ã˜stvÃ¦r]], _Existence and uniqueness of E-infinity structures on motivic K-theory spectra_, ([arXiv](http://arxiv.org/abs/1010.3944))

* [[Ivan Panin]], K. Pimenov, [[Oliver RÃ¶ndigs]], _On the relation of Voevodskyâ€™s algebraic cobordism to Quillenâ€™s K-theory_, Inventiones mathematicae, 2009, 175(2), 435-451, [DOI](http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.244.7301), [arXiv](http://arxiv.org/abs/0709.4124).
