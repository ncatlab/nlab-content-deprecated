...
The theory of [[simplicial weak Ï‰-categories]] is based on stratified simplicial sets.
...
* A [[complicial set]] is a stratified simplicial set satisfying certain extra conditions. Complicial sets are precisely those simplicial sets which arise (up to isomorphism) as the [[oriental|Ï‰-nerve]] $N(C)$ of a [[strict Ï‰-category]] $C$, where the thin cells are the images of the identity cells of $C$.
...
Using the canonical stratification of [[oriental|Ï‰-nerves]] on [[strict Ï‰-categories]] as [[complicial sets]], the $\omega$-nerve is a functor
