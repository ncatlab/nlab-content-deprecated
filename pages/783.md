...
* _La Longue Marche Ã  travers la ThÃ©orie de Galois_ (1600 manuscript pages written between January and June 1981, plus addenda etc. which double its length!) (see [[Long March]] for some discussion of the ideas.)
...
*  _Ã€ la poursuite des Champs_ (also entitled ''[[Pursuing Stacks]]'').  
...
*  _[[Les DÃ©rivateurs]]_ (another 2000 page manuscript taking  up some of the themes in Pursuing Stacks, section 69) Dating from the end of 1990 and the start of 1991.

In the same time he also wrote voluminous intellectual memoirs _Recoltes et Semailles_. 

En Guise de Programme [p I](https://webusers.imj-prg.fr/~leila.schneps/grothendieckcircle/Guise1.jpg) [p II](https://webusers.imj-prg.fr/~leila.schneps/grothendieckcircle/Guise2.jpg), a text written by Grothendieck as a course description while teaching in Montpellier "Introduction Ã  la recherche". 
...
* [[Pierre Deligne]], _Quelques idÃ©es maÃ®tresses de l'Å“uvre de A Grothendieck_ ([pdf](http://www.math.jussieu.fr/~leila/grothendieckcircle/Mathbiographies/Deligne.pdf))
...
* _Une entrevue avec [[Jean Giraud]], Ã  propos d'Alexandre Grothendieck_ ([pdf](https://webusers.imj-prg.fr/~leila.schneps/grothendieckcircle/giraud.pdf)).
...
* Allyn Jackson, _Comme AppelÃ© du NÃ©ant_, As If Summoned from the Void:
...
* "_The obituary begins here with a brief sketch of Grothendieckâ€™s life,
followed by a description of some of his most outstanding work in mathematics._" Alexandre Grothendieck 1928â€“2014, ([Part 1] (http://www.ams.org/journals/notices/201603/rnoti-p242.pdf))

* "_set of reminiscences by some of the many mathematicians who knew Grothendieck and were influenced by him._" Alexandre Grothendieck 1928â€“2014, ([Part 2](http://www.ams.org/publications/journals/notices/201604/rnoti-p401.pdf)).
