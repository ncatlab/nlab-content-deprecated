...
is the **endomorphism dg-Lie algebra** of $V$. Or, since dg-Lie algebras are special cases of [[L-âˆž algebra]]s: the **endomorphism $L_\infty$-algebra** of $V$.

## Representation

A [[representation]] of an [[L-âˆž algebra]] $\mathfrak{g}$ on a chain complex $V$ is a morphism of $L_\infty$-algebras
...
[[!redirects endomorphism L-âˆž algebra]]
[[!redirects endomorphism L-âˆž algebras]]
