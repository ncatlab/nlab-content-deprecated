...
Now characterizing an [[elementary particle]] is (by the discussion at _[[unitary representation of the PoincarÃ© group]]_) the [[momentum]] 4-vector $(p^i)$ and its [[angular momentum]] [[tensor]] $(M^{i j})$. A **twistor** is effectively a pair of spinorial coordinates expression this data for _massless_ and _chiral_ particles.
...
* {#Penrose67} [[Roger Penrose]], _Twistor algebra_,  Journal of Mathematical Physics 8 (2): 345â€“366, (1967) 

* [[Roger Penrose]], _The twistor programme, Reports on Mathematical Physics 12 (1): 65â€“76 (1977)
