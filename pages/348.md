...
When one passes from just presheaves to [[(âˆž,1)-presheaves]], then [[cover]]ing presheaves will be given by the right kind of colimit over these [[simplicial object|simplicial]] diagrams (namely the [[homotopy limit|homotopy colimit]]). More on that is at [[descent]].
...
In the context of [[(âˆž,1)-categories]] sieves are discussed around def. 6.2.2.1 of
