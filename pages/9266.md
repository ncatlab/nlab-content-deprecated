...
ambient [[(âˆž,1)-topos]] $\mathbf{H} = $ [[SmoothâˆžGrpd]]. 

We use in there mostly just the [[full sub-(âˆž,1)-category]]
...
(More generally we consider [[smooth super âˆž-groupoids]] and replace $\mathbf{B}^2 U(1)$ by the moduli stack of [[super 2-line bundles]].)

Since this is necessarily a [[dualizable objects]] in the [[(âˆž,2)-category]] of [[(âˆž,n)-category of correspondences|correspondences]] $Corr_2(\mathbf{H}, \mathbf{B}^2 U(1))$ it induces by the [[cobordism theorem]] a **[[local prequantum field theory]]** given by a [[monoidal (âˆž,n)-functor|monoidal (âˆž,2)-functor]]
...
We discuss aspects of the [[extended geometric quantization]] of one of the simplest and yet interesting examples of [[schreiber:âˆž-Chern-Simons theory]], namely [[2d Chern-Simons theory]] and here specifically the case induced by a binary and non-degenerate [[invariant polynomial]], namely the [[Lie integration|Lie integrated]] version of the [[Poisson sigma-model]].
...
We demonstrate in the following how this is indeed the result of applying the [[âˆž-Chern-Weil homomorphism]] to this situation.
...
The corresponding [[infinity-Chern-Weil theory|infinity-Chern-Weil homomorphism]] that we need to compute is given by the [[âˆž-anafunctor]]
