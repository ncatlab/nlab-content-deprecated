...
+-- {: .num_theorem} 
###### Theorem 
A valuation ring is a [[PrÃ¼fer domain]]. 
=-- 

+-- {: .proof} 
###### Proof 
There are many characterizations of Pr&uuml;fer domains, but one is that the [[lattice]] of [[ideals]] is [[distributive lattice|distributive]], which is obviously the case if the lattice is [[linear order|linearly ordered]]. 
=-- 
