...
Various authors have proposed ([Butterfield-Hamilton-Isham](#ButterfieldHamiltonIsham), [DÃ¶ring-Isham](#DoeringIsham), 
...
Moreover, inside $\mathcal{T}_A$ the [[quantum mechanics|quantum mechanical]] kinematics encoded by $B(\mathcal{H})$ looks like [[classical mechanics]] kinematics internal to $\mathcal{T}_A$ ([HeunenLandsmannSpitters](#HeunenLandsmanSpitters), following [DÃ¶ringIsham](#DoeringIsham)):
...
* [[Alain Connes]], _A factor not anti-isomorphic to itself_, Annals of Mathematics, 101 (1962), no. 3, 536â€“554. ([JSTOR](http://www.jstor.org/stable/1970940))
...
This is the theorem in ([Harding-DÃ¶ring](#HardingDoering)).

There is a generalization of this theorem to more general [[C-star algebras]] in ([Hamhalter](#Hamhalter)).

For more on this see at _[[Harding-DÃ¶ring-Hamhalter theorem]]_.
...
This opposite order on commutative subalgebras may be seen as the information order from [[Kripke semantics]]: a larger subalgebra contains more information. In this light the presheaf topos on $ComSub(A)$, as used by ([DÃ¶ring-Isham 07](#DoeringIsham)) and co-workers, may be seen as the co-Kripke model. This model is also referred to as the _coarse-graining semantics_ of quantum mechanics. See also at _[[spectral presheaf]]_.
...
Theoretical Physics, 39(6):1413â€“1436, 2000.
...
* [[Andreas DÃ¶ring]], [[Chris Isham]], _A topos foundation for theories of physics_ Journal of Mathematical Physics (2008)
{#DoeringIsham}
...
* [[John Harding]], [[Andreas DÃ¶ring]], _Abelian subalgebras and the Jordan structure of a von Neumann algebra_ ([arXiv:1009.4945](http://arxiv.org/abs/1009.4945))
{#HardingDoering}

for $A$ a [[von Neumann algebra]] and more generally for $A$ a [[C*-algebra]] in 

* [[Jan Hamhalter]], _Isomorphisms of ordered structures of abelian $C^\ast$-subalgebras of $C^\ast$-algebras_, J. Math. Anal. Appl. 383 (2011) 391â€“399 ([journal](dx.doi.org/10.1016/j.jmaa.2011.05.035))
 {#Hamhalter}

See at _[[Harding-DÃ¶ring-Hamhalter theorem]]_.
