...
In [[(âˆž,1)-category theory]] the typical notion of [[filtered object]] in [[category theory]] simplifies: instead of a [[sequential diagram]] of [[monomorphism]] it is just any [[tower diagram]].

## Definition

Let $\mathcal{C}$ be an [[(âˆž,1)-category]].
...
If $\mathcal{C}$ is a [[stable (âˆž,1)-category]] with [[sequential limits]]/[[sequential colimits]] and with a [[t-structure]], then every filtering/cofiltering on $X$ induces a [[spectral sequence of a filtered stable homotopy type]] which converges to the [[homotopy groups]] of $X$.
...
[[!redirects filtered objects in an (âˆž,1)-category]]
