...
According to 1.5 and 1.21 in the [[Locally Presentable and Accessible Categories|book]] by [[JiÅ™Ã­ AdÃ¡mek]] & [[JiÅ™Ã­ RosickÃ½]], a category has $\kappa$-directed colimits iff it has $\kappa$-[[filtered colimit|filtered]] ones, and a functor preserves $\kappa$-directed colimits iff it preserves $\kappa$-filtered ones.
