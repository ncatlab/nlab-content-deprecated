...
* In an [[(âˆž,1)-topos]] the bare notion of epimorphism disappears, and [[effective epimorphism in an (âˆž,1)-category]] becomes the default notion of epiness. A morphism in an $(\infty,1)$-topos is effective epi precisely if its [[n-truncated object in an (âˆž,1)-category|0-truncation]] is an epimorphism (hence an effective epimorphism) in the underlying 1-topos.
