...
This is called the **[[Frobenius reciprocity]]** law.  It is discussed, for instance, as ([Johnstone, lemma 1.5.8](#Johnstone)). More generally for closed monoidal categories (not necessarily cartesian monoidal) it is discussed in "[[WirthmÃ¼ller contexts]]" in 
...
In particular the [[inverse image]] functor of an [[Ã©tale geometric morphism]] between [[toposes]] is cartesian closed and hence constitutes a cartesian [[WirthmÃ¼ller context]].
