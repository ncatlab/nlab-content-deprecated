...
* [[Jacob Lurie]], _Stable $\infty$-Categories_, ([arXiv:math.CT/0608228](http://www.arXiv.org/abs/math.CT/0608228)), now section 1 in _[[Higher Algebra]]_

on [[stable homotopy theory]] in terms of  _[[stable âˆž-categories]]_.


Based on the theory of [[(âˆž,1)-category|(âˆž,1)-categories]] as developed in his book _[[Higher Topos Theory]]_, the author studies here $(\infty,1)$-categories of "stable objects", i.e. of objects that behave like [[spectrum|spectra]] in that for each object $X$ there not only its [[loop space object]] $\Omega X$ but also conversely, $X$ is the [[loop space object]] of another object $\Sigma X$. 
...
[[!redirects Stable âˆž-Categories]]
