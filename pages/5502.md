...
With a list of compatibility conditions between these (for instance ([Cisinski-DÃ©glise 09, p. x](#CisinskiDeglise09)) this is a structure of _Grothendieck's six operations_.
...
([Cisinski-DÃ©glise 09, p. x](#CisinskiDeglise09))

Morover one imposes a formalization of [[Verdier duality]] with [[dualizing object]]...

([Cisinski-DÃ©glise 09, p. xi](#CisinskiDeglise09))
...
* [[WirthmÃ¼ller context]]: $f^! \simeq f^\ast$ and $f^\ast$ is a strong [[closed monoidal functor]] (hence the [[projection formula]] for $f_!$ holds);
...
* [[Paul Balmer]], [[Ivo Dell'Ambrogio]], [[Beren Sanders]], _Grothendieck-Neeman duality and the WirthmÃ¼ller isomorphism_, [arXiv:1501.01999](http://arxiv.org/abs/1501.01999).
...
Lecture Notes in Math., no. 1960, Springer-Verlag, New York, 2009, 1â€“259. ([pdf](http://www.math.purdue.edu/~lipman/Duality.pdf))
...
* [[Joseph Ayoub]], _Les six opÃ©rations de Grothendieck et le formalisme des cycles Ã©vanescants dans le monde motivique_ PhD thesis, Paris ([pdf](http://www.math.uiuc.edu/K-theory/0761/THESE.pdf))
...
* [[Denis-Charles Cisinski]], FrÃ©dÃ©ric DÃ©glise, _Triangulated categories of mixed motives_ ([arXiv:0912.2110](http://arxiv.org/abs/0912.2110))
 {#CisinskiDeglise09}
...
[[!redirects Grothendieck\â€™s six operations]]
[[!redirects Grothendieckâ€™s six operations]]
