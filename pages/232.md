...
The page [here](http://ncatlab.org/nlab/show/generalized+algebraic+theory#Relationship%20to%20Enriched%20Categories) mentions internalization and enrichment being the result of applying two different interpretation techniques to the same theory. 
...
* A category enriched in [[simplicial sets]] is called a [[simplicially enriched category|simplicial category]], and these form one model for [[(âˆž,1)-categories]].  
...
* A category enriched in [[Top]] is a [[topologically enriched category]].  These are also a model for [[(âˆž,1)-categories]].  
...
* [[enriched (âˆž,1)-category]]

## References

A standard reference on enriched categories is
