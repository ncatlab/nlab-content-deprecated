...
It is closely related via the [[ÅoÅ› ultraproduct theorem]] to the [[compactness theorem]]: suppose one is given a set of formulas $S$ in some first-order language and a family of structures such that any finite subset of formulas is modeled by all but a finite number of structures. Then an ultraproduct of those structures may be used to model the entire set $S$.[^compact] 
...
* S. Fakir, L. Haddad, _Objets cohÃ©rents et ultraproduits dans les catÃ©gories_  , Journal
of Algebra **21** (1972) pp.410â€“421.
...
Mathematical Logic **7** (1974) pp.163â€“195.
...
* [[M. Makkai]], _Ultraproducts and categorical logic_ , Lectures Notes in Math. __1130__, Springer 1985, pp. 222â€“309.
