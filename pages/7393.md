...
The _model structure for Segal operads_  is a [[presentable (âˆž,1)-category|presentation]] of the [[(âˆž,1)-category]] of [[(âˆž,1)-operads]] regarding these as [[enriched (âˆž,1)-category|âˆžGrpd-enriched]] [[operads]].
...
The definition of Segal pre-operads encodes a [[set]] of colors of an [[operad]], together with for each [[tree]] $T$ an [[âˆž-groupoid]] of operations in the operad of the shape of this tree  --- notably $\infty$-groupoids of $n$-ary operations if the tree is the $n$-corolla, $T = C_n$.

The condition on Segal operads encodes the existence of _composition_ of these operad operations by [[âˆž-anafunctors]]. See the discussion at _[[Segal category]]_ for more on this.
