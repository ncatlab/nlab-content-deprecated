...
While an [[algebraic definition of higher category|algebraic]] definition of [[strict Ï‰-categories]] is comparatively straightforward, algebraic definitions of fully weak $\omega$-categories (aka $\infty$-[[infinity-category|categories]]) are difficult to work with (although some definitions exist, such as those of [[Batanin Ï‰-category|Batanin]], [[Trimble n-category|Trimble]], [[Leinster n-category|Leinster]], and [[n-category|Penon]]).
...
To distinguish the study of weak $\omega$-categories in terms of their presumed nerves from the study of their would-be algebraic descriptions people speak of [[simplicial weak omega-category|simplicial weak Ï‰-categories]], see in particular the articles by Dominic Verity referenced below.  One should just beware that in this context [[simplicial weak Ï‰-category]] is not meant as [[simplicial object]] in the category of weak $\omega$-categories.
...
>**Simplicial models for weak $\omega$-categories** -- sometimes called [[simplicial weak omega-category|simplicial weak Ï‰-categories]] -- are [...]
Maybe that was just poorly written, but it threw me off.
Should it be
>A **simplicial model for weak $\omega$-categories** -- which are then sometimes called [[simplicial weak Ï‰-categories]] -- is [...]
or even
>A **simplicial model for weak $\omega$-categories** is [...]
and only later mention [[simplicial weak Ï‰-categories]]?
...
_Toby_:  Thanks, that\'s much clearer.  And if Verity\'s definition is at [[weak complicial set]], then we may not really need anything at [[simplicial weak Ï‰-category]], so no need to offend Mike\'s sensibilities (^_^) either.

=--

[[!redirects simplicial model for weak Ï‰-categories]]
[[!redirects simplicial models for weak Ï‰-categories]]
