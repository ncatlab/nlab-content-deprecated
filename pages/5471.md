...
For $\mathcal{G}$ a [[geometry (for structured (âˆž,1)-toposes)]] a $\mathcal{G}$-[[structured (âˆž,1)-topos]] $(\mathcal{X}, \mathcal{O}_{\mathcal{X}})$ is _locally representable_ if it is locally equivalent to $Spec U$ for $U \in Pro(\mathcal{G})$ (the [[pro-objects in an (âˆž,1)-category]]), or $U \in \mathcal{G}$ itself if it is _locally finite presented_ .
...
Let $\mathcal{G}$ be a [[geometry (for structured (âˆž,1)-toposes)]]. Write $\mathcal{G}_0$ for the underlying
...
Recall the notation $LTop(\mathcal{G})$ for the [[(âˆž,1)-category]] of $\mathcal{G}$-[[structured (âˆž,1)-topos]]es and [[geometric morphism]]s between them.
...
There is a pair of [[adjoint (âˆž,1)-functor]]s
...
Write $\mathbf{Spec}^{\mathcal{G}}$ for the [[(âˆž,1)-functor]]
...
A $\mathcal{G}$-[[structured (âˆž,1)-topos]] in the image of this functor is an **affine $\mathcal{G}$-scheme**.
...
A $\mathcal{G}$-[[structured (âˆž,1)-topos]] $(\mathcal{X},\mathcal{O}_{\mathcal{X}})$ is a **$\mathcal{G}$-scheme** if 
...
* for every $U_i$ there exists an equivalence
  ...
  of structured $(\infty,1)$-toposes for some $A_i \in Pro(\mathcal{G})$ (in the [[(âˆž,1)-category]] of [[pro-object]]s of $\mathcal{G}$).
...
Let $\Tau$ be a [[pregeometry (for structured (âˆž,1)-toposes)]] and let $\Tau \hookrightarrow \mathcal{G}$ be an inclusion into an enveloping [[geometry (for structured (âˆž,1)-toposes)]].
...
See at _[[E-âˆž scheme]]_ and _[[E-âˆž geometry]]_.
...
* **locally representable structured (âˆž,1)-topos**
...
[[!redirects locally representable structured (âˆž,1)-topos]]

[[!redirects locally representable structured (âˆž,1)-toposes]]
