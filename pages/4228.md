...
* The [[(âˆž,1)-sheaf (âˆž,1)-topos]] over $CartSp_{th}$ is disucssed at [[synthetic differential âˆž-groupoid]]. It contains that Cahiers topos as the sub-[[(n,1)-topos|(1,1)-topos]] of [[0-truncated]] objects.
...
* {#Dubuc79} [[Eduardo Dubuc]], _Sur les modÃ¨les de la gÃ©omÃ©trie diffÃ©rentielle synthÃ©tique_ [[Cahiers]] de Topologie et GÃ©omÃ©trie DiffÃ©rentielle CatÃ©goriques, 20 no. 3 (1979), p. 231-279  ([numdam](http://www.numdam.org/item?id=CTGDC_1979__20_3_231_0)).
...
With an eye towards [[FrÃ¶licher space]]s the site is also considered in section 5 of 

* Hirokazu Nishimura, _Beyond the Regnant Philosophy of Manifolds_ ([arXiv:0912.0827](http://arxiv.org/abs/0912.0827))

The [[(âˆž,1)-topos]] analog of the Cahiers topos ([[synthetic differential âˆž-groupoids]]) is discussed in section 3.4 of
