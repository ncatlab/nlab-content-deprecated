...
The original Fourier-Mukai transform proper is the special case of the above where $X$ is an [[abelian variety]], $Y = A^\vee$ its [[dual abelian variety]] and $E$ is the corresponding [[PoincarÃ© line bundle]].
...
* {#Mukai81} [[Shigeru Mukai]],  _Duality between $D(X)$ and $D(\hat X)$ with its application to Picard sheaves_. Nagoya Mathematical Journal 81: 153â€“175. (1981)
