...
The [[adjunction]] $a_!\dashv a^*$ generates a [[monad]] $\mathbf{T}^a=(T^a,\mu^a,\eta^a)$ in the usual way: the functor is $T^a = a^* a_!\colon  F(A_1)\to F(A_1)$, the multiplication is $\mu^a = a^* \epsilon^a a_!\colon  T^a \circ T^a \to T^a$, and the unit is just the unit of the adjunction.  Denote by $F^a$ the [[Eilenbergâ€“Moore category]] $F(A_1)^{\mathbf{T}^a}$ of modules (algebras) over the monad $\mathbf{T}^a$, with canonical forgetful functor $U^{\mathbf{T}} \colon  F^a \to F(A_1)$ and canonical comparison functor $\Phi^a : F(A_0) \to F^a$.
...
in $A$, the canonical transformation $c_! a^* \to b^* d_!$ is an isomorphism.   In the BÃ©nabou--Roubaud paper this is called the *Chevalley property* and said to make $P$ into a *Chevalley functor*.
...
The __BÃ©nabou--Roubaud theorem__ asserts that this induces an [[equivalence of categories]] between $Desc(a)$ and $F^a$.  
...
+-- {: .un_prop}
###### Proposition
(DuÅ¡ko PavloviÄ‡, in Category theory Como 1990, LNM 1488, Springer 1991)
...
* {#BenabouRoubaud70} [[Jean BÃ©nabou]], [[Jacques Roubaud]], _Monades et descente_, C. R. Acad. Sc. Paris, t. 270 (12 Janvier 1970), Serie A, 96--98, ([link](http://gallica.bnf.fr/ark:/12148/bpt6k480298g/f100), BibliothÃ¨que nationale de France)

A translation into English of the above article appears at 

* Peter Heinig ([MO user page](https://mathoverflow.net/users/108556/peter-heinig)), English Reference for the BÃ©nabou-Roubaud theorem, [link](https://mathoverflow.net/q/279152) (version: 2017-08-20).
...
[[!redirects Benabouâ€“Roubaud theorem]]
[[!redirects Benabou--Roubaud theorem]]
[[!redirects BÃ©nabou-Roubaud theorem]]
[[!redirects BÃ©nabouâ€“Roubaud theorem]]
[[!redirects BÃ©nabou--Roubaud theorem]]
