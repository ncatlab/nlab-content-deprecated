...
In the more general context of [[(âˆž,1)-topos theory]] an **$(\infty,1)$-geometric embedding** is an [[(âˆž,1)-geometric morphism]]
...
such that the [[right adjoint]] [[direct image]] $f_*$ is a [[full and faithful (âˆž,1)-functor]].

See [[reflective sub-(âˆž,1)-category]] for more details.
...
[[!redirects (âˆž,1)-geometric embedding]]
[[!redirects (infinity,1)-geometric embedding]]

[[!redirects sub-(âˆž,1)-topos]]
[[!redirects sub-(âˆž,1)-toposes]]
