...
A plain $n$-dimensional local [[FQFT]] (a [[bulk]] field theory) is a [[monoidal (âˆž,n)-functor|symmetric monoidal]] [[(âˆž,n)-functor]] from the [[(âˆž,n)-category of cobordisms]]. 
...
A general formulation via an [[(âˆž,n)-category of cobordisms]] with defects is in section 4.3 of 
...
Discussion of defects in [[prequantum field theory]], hence for [[coefficients]] in an [[(âˆž,n)-category of spans]] is in 
...
* Defects in 2-dimensional [[conformal field theory]] have a long history in real-world application, for instance in [[Kramers-Wannier duality]]
  ...
  * [[JÃ¼rg FrÃ¶hlich]], [[JÃ¼rgen Fuchs]], [[Ingo Runkel]], [[Christoph Schweigert]], _Kramers-Wannier duality from conformal defects_ ([arXiv:cond-mat/0404051](http://arxiv.org/abs/cond-mat/0404051))

  * FrÃ¶hlich, Fuchs, Runkel, Schweigert, _Duality and defects in rational conformal field theory_ ([arXiv](http://arxiv.org/abs/hep-th/0607247))
