...
Where an ordinary [[category]] has a [[hom-set]], an [[(âˆž,1)-category]] has an [[âˆž-groupoid]] of morphisms between any two objects, a _hom-space_.

There are several ways to _present_ an [[(âˆž,1)-category]] $\mathbf{C}$ by an ordinary [[category]] $C$ equipped with some extra structure: for instance $C$ may be a [[category with weak equivalences]] or a [[model category]] or even a [[simplicial model category]]. In all of these presentations, given two objects $X, Y \in C$, there is a way to construct a [[simplicial sets]] $\mathbb{R}\mathbf{C}(X,Y)$ that presents the hom-[[âˆž-groupoid]] $\mathbf{C}(X,Y)$. This simplicial set -- or rather its [[homotopy type]] -- is called the 
_derived hom space_ or  _homotopy function complex_ and denoted $\mathbf{R}Hom(X,Y)$ or similarly.

## Presentations

There are many ways to present an [[(âˆž,1)-category]] by [[category theory|category theoretic data]], and for each of these there are corresponding tools for explicitly computing the derived hom spaces.
...
For $C$ a [[simplicial model category]] and $X$ an object, the [[delooping]] of the [[automorphism âˆž-group]]
...
[[core]] of the [[(âˆž,1)-category]] determined by $C$.
...
That core, like every [[âˆž-groupoid]] is equivalent to the disjoint union over its connected components of the deloopings of the automorphism $\infty$-groups of any representatives in each connected component.
...
* [[Denis-Charles Cisinski]], _Invariance de la K-th&eacute;orie par equivalences d&eacute;riv&eacute;es_, J. K-theory, 6 (2010), 505â€“546.
 {#Cisinski10}

and section 3.6.2 of 

* [[Thomas Nikolaus]], [[Urs Schreiber]], [[Danny Stevenson]], _[[schreiber:Principal âˆž-bundles -- theory, presentations and applications|Principal âˆž-bundles -- Presentations]]_ ([arXiv:1207.0249](http://arxiv.org/abs/1207.0249))
 {#NSS12}
...
[[!redirects (âˆž,1)-categorical hom-space]]
[[!redirects (âˆž,1)-categorical hom-spaces]]


[[!redirects (infinity,1)-categorical hom space]]
[[!redirects (âˆž,1)-categorical hom space]]
[[!redirects (infinity,1)-categorial hom-space]]
[[!redirects (âˆž,1)-categorial hom-space]]
[[!redirects (infinity,1)-categorial hom space]]
[[!redirects (âˆž,1)-categorial hom space]]
...
[[!redirects hom-âˆž-groupoid]]
[[!redirects hom-infinity-groupoid]]
[[!redirects hom-(âˆž,0)-category]]
...
[[!redirects (âˆž,1)-hom (âˆž,1)-functor)]]

[[!redirects (âˆž,1)-categorical hom]]
