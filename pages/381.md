...
A _strict $\omega$-category_ is a [[globular set|globular]] [[âˆž-category]] in which all operations obey their respective laws strictly.

This was the original notion of [[âˆž-category]], and the original meaning of the term [[Ï‰-category]]. Even today, most authors who use that term still mean this notion.
...
Based on this fact, there are attempts to weaken the condition on a [[simplicial set]] to be a [[complicial set]] so as to obtain a notion of [[simplicial weak Ï‰-category]].
...
* [[Ronnie Brown]] and P.J. Higgins, _The equivalence of $\infty$-groupoids and crossed complexes_, Cah. Top. G&eacute;om. Diff. 22 (1981) no. 4, 371-386 [web](http://www.numdam.org/item?id=CTGDC_1981__22_4_371_0).
...
* R. Brown, _Non-abelian cohomology and the homotopy classification of maps_,  in Homotopie alg&eacute;brique et algebre locale, Conf. Marseille-Luminy 1982,  ed. J.-M. Lemaire et J.-C. Thomas,
Ast&eacute;risques 113-114 (1984), 167-172.
...
* R. Steiner, _Omega-categories and chain complexes_, Homology, Homotopy and Applications __6__(1), 2004, pp.175â€“200, [pdf](http://www.intlpress.com/HHA/v6/n1/a12/v6n1a12.pdf)
[[!redirects strict Ï‰-category]]
[[!redirects strict Ï‰-categories]]
