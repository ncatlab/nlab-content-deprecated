...
* When restricted to [[Grpd]], this is the special case of the [[n-connected/n-truncated factorization system]] in the [[(âˆž,1)-topos]] [[âˆžGrpd]] for the case that $(n = 0)$ and restricted to [[1-truncated]] [[objects]].
