...
* For any [[âˆž-cosmos]] $K$, there is a smothering 2-functor $(K/A)_2 \to K_2/A$, where $K_2$ denotes the [[homotopy 2-category]] of an [[âˆž-cosmos]].  In the special case when $K=QCat$ consists of [[quasi-categories]], this is [RV, 3.4.7](#RV).
