...
_Homotopical algebraic geometry_ is a [[homotopy theory|homotopical]] generalization of [[algebraic geometry]], where the [[affine schemes]] are not necessarily [[commutative algebras]] in the usual sense, but rather [[commutative algebra in an (âˆž,1)-category|commutative algebra objects]] in an arbitrary [[symmetric monoidal (infinity,1)-category]].
In other words, it is the specialization of [[higher geometry]] where the local models are [[commutative algebra in an (âˆž,1)-category|commutative algebras]] in a [[symmetric monoidal (infinity,1)-category]].
...
Given a [[symmetric monoidal (infinity,1)-category]] $C$, let $CAlg(C)$ denote the [[(infinity,1)-category]] of [[commutative algebra in an (âˆž,1)-category|commutative algebra objects]] in $C$.
...
* [[Bertrand ToÃ«n]], [[Gabriele Vezzosi]], _Homotopical algebraic geometry I: topos theory_, 2002, [arXiv:math/0207028](http://arxiv.org/abs/math/0207028).
...
An exposition in the style of ToÃ«n-Vezzosi but in the language of [[(infinity,1)-categories]] can be found in
