...
In [[microlocal analysis]], the _wave front set_ ([H̦rmander 70](#Hoermander70)) of a [[generalized function]] such as a [[distribution]] or a [[hyperfunction]] is a characterization of the singularity structure of the generalized function, hence of how it deviates from being an ordinary smooth function.

The wave front set is the sub-bundle of the [[cotangent bundle]] that consists of all those directions (non-zero [[covectors]]) such that the local [[Fourier transform]] of the distribution is not rapidly decaying in this direction ([H̦rmander 90, section 8.1](#Hoermander90)).  Such covectors are stable under multiplication by positive scalars, so the wave front set can also be considered as a sub-bundle of the [[unit sphere bundle]] of the [[cotangent bundle]].
...
For instance the [[product of distributions]] is well defined precisely if the sum of their wave front sets does not intersect the zero-section ([H̦rmander 90, theorem 8.2.10](#Hoermander90)).
...
([H̦rmander 70 (2.4.1)](#Hoermander70), [H̦rmander 90, section 8.1](#Hoermander90))

This definition turns out to make invariant sense ([H̦rmander 90, p. 256](#Hoermander90)).
...
([H̦rmander 90, theorem 8.2.9](#Hoermander90))
...
e.g. ([H̦rmander 90, below (8.1.1)](#Hoermander90))
...
* {#Hoermander70} [[Lars H̦rmander]], _Linear differential operators_, Actes Congr. Int. Math. Nice 1970, 1, 121-133 ([pdf](http://www.mathunion.org/ICM/ICM1970.1/Main/icm1970.1.0121.0134.ocr.pdf))
...
* {#Hoermander94} [[Lars H̦rmander]], _The analysis of linear partial differential operators_, vol. III, Springer 1994

A history of the concept of wave front sets with extensive pointers to the 
literature is given in [H̦rmander 90, p. 322-324](#Hoermander90).
...
* {#DuistermaatHoermander72} [[Johann Duistermaat]], [[Lars H̦rmander]], sections 6.5, 6.6 of _Fourier integral operators II_, Acta Mathematica 128, 183-269, 1972 ([Euclid](https://projecteuclid.org/euclid.acta/1485889724))
