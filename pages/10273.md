...
These notes concern the generalization of the notion of _[[gerbes]]_, of _[[principal 2-bundles]] with [[principal 2-connections]]_ and generally of _[[principal âˆž-bundles]] with [[principal âˆž-connection]]_ from [[higher differential geometry]] modeled on [[smooth manifolds]] to _[[higher supergeometry]]_ modeled on [[supermanifolds]].
...
Since early observations in the 1980s ([GawÄ™dzki 87](#Gawedzki87)) and then more prominently since ([Freed-Witten 99](FreedWitten99), [Carey-Johnson-Murray 02](#CareyJohnsonMurray02))), it is known that the [[B-field]] in [[string theory]] is mathematically a [[circle 2-bundle with connection]] and that the _[[WZW term]]_ in the [[action functional]] of the 2-dimensional [[string]] [[sigma-model]] with such a [[background gauge field]] is the [[surface holonomy]] of this 2-connection, in higher analogy of how the gauge [[interaction]] term of the [[electromagnetic field|electromagnetically]] [[charged particle]] is the line [[holonomy]] of a [[circle bundle with connection]] over the [[worldline]] of the [[particle]]. 
...
By general principles of [[higher geometry]] it is clear what [[higher supergeometry]] is to be: the theory of [[âˆž-stacks]] over a [[site]] of [[supermanifolds]], hence of _[[smooth super âˆž-groupoids]]_. The general notions of [[principal âˆž-bundles]] and of [[principal âˆž-connections]] apply to this ([[cohesive (âˆž,1)-topos|cohesive]]) [[(âˆž,1)-topos]] as to any other and hence in principle provide all the relevant structure.

It remains to work out more examples and applications. A good testing ground is the [[infinitesimal object|infinitesimal]] approximation of [[smooth super âˆž-groupoids]] by their _[[super L-âˆž algebras]]_. It turns out ([SSS 09](#SSS09)) that that these have _implicitly_ been recognized and used in the study of higher [[supergravity]] for a long time, starting with ([D'Auria-FrÃ©-Regge 80](#DAuriaFre80)) and fully developed in ([Castellani-D'Auria-FrÃ© 91](CastellaniDAuriaFre91)), namely in their dual incarnation via their [[Chevalley-Eilenberg algebras]]. In ([Nieuwenhuizen 83](#Nieuwenhuizen83)) these super-dg-algebras have been called "free differential algebras", abbreviated "FDA", referring to the fact that their underlying graded superalgebra is free on a [[super vector space]], hence is a super-[[Grassmann algebra]]. Since the [[differential]] on these [[Chevalley-Eilenberg algebras]] is crucially _not_ [[free construction|free]], in general, this is an unfortunate misnomer, but it did stick and is used ever since in the [[supergravity]] literature, see the references at _[[D'Auria-FrÃ© formulation of supergravity]]_ and at _[[Green-Schwarz action functional]]_.

If however one does make the [[homotopy theory of L-âˆž algebras]] explicit that is hidden in the "FDA"-formulation of [[supergravity]], then one sees that a large part of the literature has secretly been describing the infinitesimal approximation to [[supergeometry|supergeometric]] [[schreiber:âˆž-Wess-Zumino-Witten theory|higher WZW terms]] all along ([FSS 13b](#FSS13b)), namely in form of the [[Green-Schwarz action functionals]] for [[sigma-models]] of higher-dimensional [[branes]] propagating in a [[super spacetime]] [[target space]]. By ([FSS 13b, last section](#FSS13b)), each of these [[perturbation theory|perturbative]] action functionals formulated (implicitly) in terms of [[super L-âˆž algebra|super L-âˆž algebraic data]] [[Lie integration|Lie integrates]] to a genuine ([[non-perturbative field theory|non-perturbative]]) [[schreiber:âˆž-Wess-Zumino-Witten theory|âˆž-WZW model]] in [[higher supergeometry]]. 

The present notes are aimed at spelling out class of examples of "super [[âˆž-gerbes]]", but for the most part they apply more generally and only take their motivation from this example.

$\,$

We start with traditional basics, first introducing [[superpoints]] and [[supermanifolds]], then recalling the [[spin group]] and the classification of its [[spin representations]], and then combining both to build $N$-[[supersymmetry|supersymmetric]] [[super Minkowski spacetimes]] as [[coset spaces]] of the [[super PoincarÃ© group]] of $N$ [[supersymmetries]].

Then we introduce [[higher supergeometry]] in terms of [[super stacks]]/[[smooth super âˆž-groupoids]] and finally discuss how all the exceptional [[L-âˆž cocycles]] of [[super Minkowski spacetime]] and its higher [[L-âˆž extensions]] yield the [[Green-Schwarz sigma models]] of the [[brane scan]] of [[string theory]]/[[M-theory]], and in fact the whole [[schreiber:The brane bouquet|brane bouquet]] of branes with "tensor multiplet" fields, such as the [[D-branes]] and notably the [[M5-brane]].
...
In precisely the same fashion one finds all super-algebraic structures such as for instance also [[super L-âˆž algebras]], which become important [below](#HigherSupergeometry) in the discussion of [[higher supergeometry]].
...
The symmetries of $d$-dimensional [[Minkowski space]] $\mathbb{R}^{d-1|1}$ are given by the [[PoincarÃ© group]], which has the [[Lie algebra]]
\[
	\mathfrak{g}_0 = \mathbb{R}^{d-1|d} \ltimes \mathfrak{so}(d-1,1)
\]
To get the [[super PoincarÃ© Lie algebra]] from this, we would like to extend it by an odd part $\mathfrak{g}_1$ given by a spin representation $S$. In general, a [[super Lie algebra]] can be obtained from the following data:
...
This allows to form the [[super PoincarÃ© Lie algebra]] in each of these cases. See there and see _[Spinor bilinear forms](#SpinorBilinearForms)_ below for more.

=--


## **4)** Super PoincarÃ© group and super Minkowski spacetime
 {#SuperMinkowskiSpacetime}


### Summary

Ordinary [[Minkowski space]] $\mathbb{R}^{d-1,1}$ happens to be [[coset space]] which is the quotient of (the double cover of) its own Lie group of oriented [[isometries]], the [[PoincarÃ© group]] $Iso(d-1,1)$ by (the [[spin group|spin]] [[double cover]] of) the [[Lorentz group]] $SO(d-1,1)$ of rotations and boosts:
...
for a [[super Lie algebra]] [[Lie algebra extension|extension]] $\mathfrak{siso}_N(d-1,1)$ of the [[PoincarÃ© Lie algebra]] by a [[spin representation]] in odd degree -- a [[super PoincarÃ© Lie algebra]] -- one _defines_ the corresponding [[super Minkowski spacetime]] as the quotient
...
Above we already mentioned that ordinary [[supergeometry]] takes place in the [[topos]] $Sh(SuperPoints)$ of "super sets". In order to model [[super âˆž-groupoids]] we hence naturally pass to the [[(âˆž,1)-topos]] over the [[site]] of [[superpoints]]. In order to equip these with [[smooth structure]] such as to yield [[smooth super âˆž-groupoids]] we form the [[(âˆž,1)-sheaf (âˆž,1)-topos]]

[[SmoothSuperâˆžGrpd]] $\coloneqq Sh_\infty\left(\left\{\mathbb{R}^{p|q}\right\}_{p,q \in \mathbb{N}}\right) \simeq Sh_\infty\left(SuperManifolds\right)$

over [[supermanifolds]] (see for instance [FSS 13a](#FSS13a)). 


As in any [[(âˆž,1)-topos]], there is a canonical notion of [[principal âˆž-bundles]], of [[associated âˆž-bundles]] and of [[âˆž-gerbes]] in [[SmoothSuperâˆžGrpd]] ([NSS 12](#NSS12)).
The basic fact of relevance here is that [[SmoothSuperâˆžGrpd]] is  _[[cohesive (âˆž,1)-topos|cohesive]]_ ([S](#S)) and hence also admits refinements of these structures to [[differential cohomology]]. 

In particular, due to [[cohesion]] every [[super âˆž-group]] $G \in Grp(SmoothSuper\infty Grpd)$ naturally has a canonical higher [[Maurer-Cartan form]] exhibited by a [[cocycle]]

$$
  \theta_G \;\colon\; G \longrightarrow \flat_{dR}\mathbf{B}G
$$

with [[coefficients]] in non-abelian de Rham hypercohomology. Since the ordinary [[WZW gerbe]] is characterized by a 3-cocycle $\mu$ in [[Lie algebra cohomology]] such that $\mu(\theta_Q) \colon G \to \Omega^3_{cl}$ is its [[curvature]] 3-form, this is a crucial ingredient for the definition of [[schreiber:âˆž-Wess-Zumino-Witten theory]] models. This we come to [below](#SuperWZWBundles).
...
We discuss how to construct [[circle n-bundles with connection]] ("bundle (n-1)-gerbes") on [[super Lie groups]] and on [[smooth super âˆž-groupoid|super âˆž-groups]] which generalize the familiar [[WZW model|Wess-Zumino-Witten term]] that serves as the [[action functional]] for the [[sigma-model]] that describes a [[string]]  propagating on a [[Lie group]]. Following the "[[holographic principle]]" we construct these [[schreiber:âˆž-Wess-Zumino-Witten theory|âˆž-Wess-Zumino-Witten theories]] as [[boundary field theories]] for [[schreiber:âˆž-Chern-Simons theories]] (which in turn are realized as [[boundary field theories]] for higher [[topological Yang-Mills theories]]).

Finally we apply this general construction of supergeometric [[schreiber:âˆž-Wess-Zumino-Witten theory|âˆž-Wess-Zumino-Witten theories]] to the exceptional [[super L-âˆž algebra]] [[extended supersymmetry]] algebras and thus find the [[non-perturbative field theory|non-pertrubative]] formulation of the $p$-[[brane]] [[sigma-models]] in [[string theory]]/[[M-theory]] which constitute the [[brane scan]]/[[schreiber:The brane bouquet]].
...
We say that this is the [[(âˆž,1)-topos]] of _[[smooth super âˆž-groupoids]]_/_[[supergeometry|supergeometric]] [[moduli âˆž-stacks]]_.
...
be the [[(âˆž,n)-category]] of $n$-fold [[correspondences]] in $\mathbf{H}$. This is a [[symmetric monoidal (âˆž,n)-category]] under the objectwise [[Cartesian product]] in $\mathbf{H}$.



[[SmoothâˆžGrpd]] has the special property that it is [[cohesive (âˆž,1)-topos|cohesive]] in that it is equipped with an [[adjoint quadruple]] of [[adjoint (âˆž,1)-functors]]
...
which induce an [[adjoint triple]] of [[idempotent monad|idempotent]] [[(âˆž,1)-monads]]/comonads
...
Write $Bord_n$ for the [[(âˆž,n)-category of cobordisms|(âˆž,n)-category of framed n-dimensional cobordisms]].

+-- {: .num_prop}
###### Proposition 

A [[monoidal (âˆž,n)-functor]] 
...
Observe that by the [[cobordism hypothesis]] $Bord_n$ is the [[free construction|free]] [[symmetric monoidal (âˆž,n)-category]] with [[fully dualizable objects]] generated from a single object $\ast$. 
...
the free [[symmetric monoidal (âˆž,n)-category]] with [[fully dualizable objects]] generated from a single object $\ast$ and a single [[morphism]] $\emptyset \longrightarrow \ast$ from the [[tensor unit]] to the generating object. By the [[boundary field theory]]/[[defect field theory|defect]] version of the [[cobordism hypothesis]], this is equivalently the [[(âˆž,n)-category of cobordisms]] with possibly a [[boundary]] component of [[codimension]] $(n-1)$.
...
The [[schreiber:âˆž-Wess-Zumino-Witten theory]] that we are after are boundaries of these boundary field theories, hence "corner field theories" ([Sati 11](#Sati11), [lpqft](#lpqft)) of the higher universal topological Yang-Mills theory. This we turn to now.
...
| [[schreiber:âˆž-Chern-Simons theory]] | $\leftarrow$[[holographic principle]]$\rightarrow$ | [[schreiber:âˆž-Wess-Zumino-Witten theory]] |
|---|---|---|
...
In order to formalize this in generality, one needs a general formalization of [[holography]] for [[local prequantum field theory]] as these. How are [[schreiber:âˆž-Wess-Zumino-Witten theory]]-models higher holographic boundaries of [[schreiber:âˆž-Chern-Simons theory]]? This we are dealing with now.
...
The datum going into [[schreiber:âˆž-Wess-Zumino-Witten theory]] is  [[smooth super âˆž-group]] $G$ which is the [[Lie integration]] of a given [[super L-âˆž algebra]] $\mathfrak{g}$, and is a [[L-âˆž algebra cohomology|cocycle]] $\mu$ on $\mathfrak{g}$.
...
Given a ([[super L-âˆž algebra|super]]-)[[L-âˆž algebra]] $\mathfrak{g}$, its [[Lie integration]] is the [[âˆž-stack]]
...
which assigns to a test ([[super Cartesian space]]-)[[Cartesian space]] $U$ the [[Kan complex]] whose $k$-[[simplices]] are smooth [[L-âˆž algebra valued differential forms]] on $U \times \Delta^k$ which are
...
An [[L-âˆž algebra cohomology|L-âˆž cocycle]] of degree $n+1$ on $\mathfrak{g}$ is a [[homomorphism]] of [[L-âˆž algebras]] of the form
...
Hence given a cocycle $\mu$, universal [[Lie integration]] produces a morphism of [[smooth super âˆž-groupoids]] of the form
...
Under [[truncated|truncation]] the universal [[Lie integration]] above descents to an $(n+1)$-[[âˆž-group cohomology|âˆž-group cocycle]] with [[coefficients]] in $\mathbb{R}/\Gamma_{\mu}$:
...
We discuss now how this construction generalizes to [[higher differential geometry]] in general, and to [[higher supergeometry]] in particular. Then in _[The brane bouquet of higher super WZW terms](#TheBraneBouquet)_ we discuss a class of examples of this construction arising from the tower of [[super L-âˆž algebra|super]] [[L-âˆž algebra cohomology|L-âˆž extensions]] of [[super Minkowski spacetime]]. ([FSS 13b](#FSS13b))
...
be a [[super L-âˆž algebra]] [[L-âˆž cocycle]] of degree $(n+1)$. Let 

$$
  \mathbf{c} \;\colon\; \mathbf{B}G \longrightarrow \mathbf{B}^{n+1}(\mathbb{R}/\Gamma)
$$

be its [[Lie integration]] in [[smooth super âˆž-groupoids]], according to ([[schreiber:Cech Cocycles for Differential characteristic Classes|FSS 10]]). 

Observe that the [[smooth âˆž-group]] $G$ has, by [[cohesion]], a canonical higher [[Maurer-Cartan form]]
...
This is a [[cocycle]] in the nonabelian de Rham [[hypercohomology]] of $G$. We want an [[schreiber:âˆž-Wess-Zumino-Witten theory]] model with a _globally defined_ [[curvature]] $(n+1)$-form. Therefore consider the [[universal construction|universal]] solution $\tilde G$ of making $\theta$ globally well defined, hence the [[homotopy pullback]]
...
Then one observes that by [[cohesion]] the [[pasting]] diagram on the right of the following exists, and hence defines a [[local action functional]] $\exp(i S_{WZW})$ by the universal factorization on the left. This is the [[schreiber:âˆž-Wess-Zumino-Witten theory]] induced by the [[L-âˆž cocycle]] $\mu$:
...
* {#DAuriaFre80} [[Riccardo D'Auria]], [[Pietro FrÃ©]] [[Tullio Regge]], _Graded Lie algebra, cohomology and supergravity_, Riv. Nuov. Cim. 3, fasc. 12 (1980) ([spire](http://inspirehep.net/record/156191))
  

* {#AzcarragaIzqierdo95} [[JosÃ© de AzcÃ¡rraga]], Izqierdo, _[[Lie Groups, Lie Algebras, Cohomology and Some Applications in Physics]]_, Cambridge monographs of mathematical physics, (1995)
...
* {#CastellaniDAuriaFre91} [[Leonardo Castellani]], [[Riccardo D'Auria]], [[Pietro FrÃ©]], _[[Supergravity and Superstrings - A Geometric Perspective]]_, World Scientific (1991)
  


* {#CAIB99} C. Chryssoâ€Œmalakos, [[JosÃ© de AzcÃ¡rraga]], J. M. Izquierdo and C. PÃ©rez Bueno, _The geometry of branes and extended superspaces_, Nuclear Physics B Volume 567, Issues 1â€“2, 14 February 2000, Pages 293â€“330 ([arXiv:hep-th/9904137](http://arxiv.org/abs/hep-th/9904137))
...
* {#Gawedzki87} [[Krzysztof GawÄ™dzki]], _Topological Actions in two-dimensional Quantum Field Theories_, in [[Gerard â€™t Hooft]] et. al (eds.) _Nonperturbative quantum field theory_ Cargese 1987 proceedings,  ([web](http://inspirehep.net/record/257658?ln=de))
  

* {#HohnholdSolzTeichner11} [[Henning Hohnhold]], [[Stephan Stolz]], [[Peter Teichner]], _Super manifolds: an incomplete survey_, Bulletin of the Manifold Atlas (2011) 1â€“6 ([pdf](http://people.mpim-bonn.mpg.de/teichner/Papers/Survey-Journal.pdf))
...
* {#NSS12} [[Thomas Nikolaus]], [[Urs Schreiber]], [[Danny Stevenson]], _[[schreiber:Principal âˆž-bundles -- theory, presentations and applications|Principal âˆž-bundles]]_ 
...
* {#SSS09} [[Hisham Sati]], [[Urs Schreiber]], [[Jim Stasheff]], _[[schreiber:L-âˆž algebra connections|L âˆž-algebra connections and applications to String- and Chern-Simons n-transport]]_, in _Quantum Field Theory_, BirkhÃ¤user (2009), 303-424, DOI: 10.1007/978-3-7643-8736-5_17 ([arXiv:0801.3480](http://arxiv.org/abs/0801.3480)) 
...
* {#SchweigertWaldorf07}[[Christoph Schweigert]], [[Konrad Waldorf]], _Gerbes and Lie Groups_, in _Trends and Developments in Lie Theory_, Progress in Math., BirkhÃ¤user ([arXiv:0710.5467](http://arxiv.org/abs/0710.5467))
