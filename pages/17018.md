...
$Spec(\mathbb{S})$ is the spectrum, in the sense of [[spectrum of a commutative ring]] in [[E-âˆž geometry]], of the [[sphere spectrum]] $\mathbb{S}$, in the sense of [[stable homotopy theory]], regarded canonically as the [[initial object in an (âˆž,1)-category|initial]] [[E-âˆž ring]].

This is the refinement to [[E-âˆž arithmetic geometry]] of what [[Spec(Z)]] is in [[arithmetic geometry]].

It is the absolute base space, in that it is the [[terminal object in an (âˆž,1)-category|terminal object]] among [[E-âˆž schemes]]. Notably for $E$ any other [[E-âˆž ring]], then the essentially unique $E_\infty$-ring homomorphism $\mathbb{S} \longrightarrow E$ (the unit, exhibiting $E$ as an [[E-âˆž algebra]] over $\mathbb{S}$) corresponds to an essentially unique morphism
...
* [spectrum of the category of spectra](prime+spectrum+of+a+symmetric+monoidal+stable+%28âˆž,1%29-category#OfCategoryOfSpectra)
