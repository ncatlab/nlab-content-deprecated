...
from the universal [[moduli stack]] of smooth $SO(n)$-[[principal bundles]] to that of $\mathbf{B}\mathbb{Z}_2$-[[principal 2-bundles]] ($\mathbb{Z}_2$-[[bundle gerbes]]). The [[homotopy fiber]] of this map in [[SmoothâˆžGrpd]] is $\mathbf{B}Spin(n)$, for the [[spin group]] regarded as a [[smooth group]].
Under [[geometric realization of cohesive âˆž-groupoids]] ${\vert - \vert} \colon Smooth\infty Grpd \longrightarrow \infty Grpd$ this maps ti the universal [[second Stiefel-Whitney class]]
...
One checks that the [[homotopy fiber]] of $\mathbf{w}_2$ in [[SmoothâˆžGrpd]] is $\mathbf{B}Spin(n)$, for $Spin(n)$ the [[spin group]] regarded as a [[smooth group]], for instance by using the techniques for computing [[homotopy pullbacks]] as discussed there. Moreover, by the general discussion at _[[smooth âˆž-groupoid -- structures]]_ this homotopy fiber is preseved under [[geometric realization of cohesive âˆž-groupoids]] so that the homotopy fiber of ${\vert \mathbf{w}_2 \vert}$ is the [[classifying space]] $B Spin(n)$. Since $\mathbb{K}(\mathbb{Z}_2,2)$ is [[connected]], this characterizes ${\vert \mathbf{w}_2 \vert}$ as $w_2$.
...
Postcomposition with $\mathbf{w}_2$ from prop. \ref{SmoothSWMap} gives a map in [[SmoothâˆžGrpd]] of the form
...
For $X$ a [[manifold]], the [[groupoid]]/[[homotopy n-type|homotopy 1-type]] $Spin(X)$ of **spin structures** over $X$ is the [[homotopy fiber]] in [[âˆžGrpd]] $\simeq$ $L_{whe}$[[Top]]  of the second [[Stiefel-Whitney class]]
...
### Over a Hermitian manifold / KÃ¤hler manifold
 {#OverAKahlerManifold}
...
* Dennis Johnson, _Spin structures and quadratic forms on surfaces_. J. London Math. Soc. (2) 22 (1980), no. 2, 365â€“373. 

See also [this MO comment](http://mathoverflow.net/a/136425/381).

Discussion of spin structure on [[KÃ¤hler manifolds]] is in 

* [[Nigel Hitchin]], _Harmonic spinors_, Adv. Math. 14 (1974), 1 âˆ’ 55. 
 {#Hitchin74}

* [[Christian BÃ¤r]], _On harmonic spinors_ ([pdf](http://www.actaphys.uj.edu.pl/vol29/pdf/v29p0859.pdf))
...
* [[Luis Alvarez-GaumÃ©]], Communications in Mathematical Physics 90 (1983) 161
