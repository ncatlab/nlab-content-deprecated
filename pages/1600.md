...
Write $Orb$ for the [[global orbit category]]. Then its [[(âˆž,1)-presheaf (âˆž,1)-category]] $PSh_\infty(Orb)$ is the [[(âˆž,1)-category]] of _orbispaces_. ([Henriques-Gepner 07](#HenriquesGepner07), [Rezk 14, remark 1.5.1](#Rezk14))
...
By the main theorem of ([Henriques-Gepner 07, (4)](#HenriquesGepner07)) the [[(âˆž,1)-presheaves]] on the global [[orbit category]] are equivalently "cellular" [[topological stacks]]/[[topological groupoids]] ("[[orbispaces]]"), we might write this as
...
* [[AndrÃ© Henriques]], _Orbispaces and orbifolds from the point of view of the Borel construction, a new definition_ ([arXiv:0112006](http://arxiv.org/abs/math/0112006))

* [[AndrÃ© Henriques]], _Vector bundles on orbispaces_ (2005) ([pdf](http://www.staff.science.uu.nl/~henri105/PDF/orbiabstract.pdf))
