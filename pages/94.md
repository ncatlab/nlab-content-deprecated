...
From another perspective: an $L_\infty$-algebra is a [[Lie âˆž-algebroid]] with a single object.

$L_\infty$-algebras are [[infinitesimal space|infinitesimal]] approximations of [[smooth âˆž-group]]s in analogy to how an ordinary Lie algebra is an infinitesimal approximation of a [[Lie group]]. Under [[Lie integration]] every $L_\infty$-algebra $\mathfrak{g}$ "exponentiates" to a [[smooth âˆž-group]] $\Omega \exp(\mathfrak{g})$.
...
[[L-âˆž algebras]] in the incarnation of higher brackets satisfying a higher Jacobi identity (def. \ref{LInfinityDefinitionViaGeneralizedJacobiIdentity}) were introduced in [Stasheff 92](#Stasheff92), [Lada-Stasheff 92](#LadaStasheff92), based on the 
...
But in this dual incarnation, [[L-âˆž algebras]] and more generally [[super L-âˆž algebras]] (of [[finite type]]) 
had secretly been introduced, independently of the [[BV-formalism]] of [Batalin-Vilkovisky 83](#BatalinVilkovisky83), [Batakin-Fradkin 83](#BatakinFradkin83),  within the [[supergravity]] literature already in [D'Auria-FrÃ©-Regge 80](#DAuriaFreRegge80) and explicitly in [van Nieuwenhuizen 82](#Nieuwenhuizen82).
The concept was picked up in the [[D'Auria-FrÃ© formulation of supergravity]] ([D'Auria-FrÃ© 82](#DAuriaFre82)) and eventually came to be referred to as "FDA"s (short for "free differential algebra") in the [[supergravity]] literature (but beware that these dg-algebras 
...
[[âˆž-group]] $\Omega X$ is reflected, infinitesimally, by an [[L-âˆž algebra]]. This perspective began to 
...
A modern review that makes this [[L-âˆž algebra]]-theoretic nature of [[rational homotopy theory]] manifest is in 
[Buijs-FÃ©lix-Murillo 12, section 2](rational+homotopy+theory#BuijsFelixMurillo12).
...
An **$L_\infty$-algebra** is an [[algebra over an operad]] in the [[category of chain complexes]] over the [[L-âˆž operad]].
...
* An $L_\infty$-algebra internal to [[super vector space]]s is a [[super L-âˆž algebra]].
...
* [[automorphism âˆž-Lie algebra]]

* For every $\infty$-Lie algebra $\mathfrak{g}$ there is its [[automorphism âˆž-Lie algebra]]. In terms of [[rational homotopy theory]] this models the rational automorphism group of the [[rational space]] corresponding to $\mathfrak{g}$.
...
See [[model structure for L-âˆž algebras]].
...
In generalization to how a [[Lie algebra]] integrates to a [[Lie group]], $L_\infty$-algebras integrate to [[âˆž-Lie group]]s.
...
<a href="http://ncatlab.org/nlab/show/Lie+infinity-groupoid#LieIntegrated">Lie integrated âˆž-Lie groupoids</a>.
...
* **$L_\infty$-algebra**
  ...
  * [[nilpotent L-âˆž algebra]]

  * [[L-âˆž algebroid]]

  * [[derived L-âˆž algebroid]]
...
The following lists, mainly in chronological order of their discovery, [[L-âˆž algebra]] structures appearing in [[physics]], notably in [[supergravity]], [[BV-BRST formalism]], [[deformation quantization]], [[string theory]], higher [[Chern-Simons theory]]/[[AKSZ sigma-models]] and [[local field theory]].
...
In their equivalent [[formal dual]] guise of [[Chevalley-Eilenberg algebras]] (see [above](#ReformulationInTermsOfSemifreeDGAlgebra)), $L_\infty$-algebras of [[finite type]] -- in fact [[super L-âˆž algebras]] -- appear in pivotal role in the [[D'Auria-FrÃ© formulation of supergravity]] at least since 

* {#DAuriaFre}  [[Riccardo D'Auria]], [[Pietro FrÃ©]] _[[GeometricSupergravity.pdf:file]]_, Nuclear Physics B201 (1982) 101-140 
...
The translation of [[D'Auria-FrÃ© formulation of supergravity|D'Auria-FrÃ© formalism]] to explicit ([[super L-âˆž algebra|super]]) $L_\infty$-algebra language is made in 

* [[Hisham Sati]], [[Urs Schreiber]], [[Jim Stasheff]], example 5 in section 6.5.1, p. 54 of _L-infinity algebra connections and applications to String- and Chern-Simons n-transport_, in Quantum Field Theory, BirkhÃ¤user (2009) 303-424 ([arXiv:0801.3480](http://arxiv.org/abs/0801.3480))
...
* {#MFFMER08} Paul de Medeiros, [[JosÃ© Figueroa-O'Farrill]], [[Elena MÃ©ndez-Escobar]], [[Patricia Ritter]], _On the Lie-algebraic origin of metric 3-algebras_, Commun.Math.Phys.290:871-902,2009 ([arXiv:0809.1086](http://arxiv.org/abs/0809.1086))
...
* {#BatalinVilkovisky81} [[Igor Batalin]], [[Grigori Vilkovisky]],  _Gauge Algebra and Quantization_, Phys. Lett. B 102 (1981) 27â€“31. doi:10.1016/0370-2693(81)90205-7
...
* {#BatalinVilkovisky83b} [[Igor Batalin]], [[Grigori Vilkovisky]],  _Quantization of Gauge Theories with Linearly Dependent Generators_, Phys. Rev. D 28 (10): 2567â€“258 (1983) doi:10.1103/PhysRevD.28.2567.  Erratum-ibid. 30 (1984) 508 doi:10.1103/PhysRevD.30.508
...
The understanding that these [[BV-BRST complexes]] mathematically are the [[formal dual]] [[Chevalley-Eilenberg algebra]] of a [[derived L-âˆž algebroid]] originates around
...
The [[L-âˆž algebroid]]-structure is also made explicit in ([def. 4.1 of v1](http://arxiv.org/abs/0910.4001v1)) of ([Sati-Schreiber-Stasheff 09](#SatiSchreiberStasheff09)).
...
Generalization to open-closed bosonic string field theory yields [[L-âˆž algebra]] interacting with [[A-âˆž algebra]]:
...
* {#KajiuraStasheff04} [[Hiroshige Kajiura]], [[Jim Stasheff]], _Homotopy algebras inspired by classical open-closed string field theory_, Comm. Math. Phys. 263 (2006) 553â€“581 (2004) ([arXiv:math/0410291](http://arxiv.org/abs/math/0410291))
...
makes crucial use of [[L-âˆž algebra]]. Later it was understood that indeed [[L-âˆž algebras]] are equivalently the universal model for infinitesimal [[deformation theory]] (of anything), also called [[formal moduli problems]]:
...
* {#Henriques} [[AndrÃ© Henriques]], _Integrating $L_\infty$ algebras_, Compos. Math. __144__  (2008), no. 4, 1017--1045 ([doi](http://dx.doi.org/10.1112/S0010437X07003405),[math.AT/0603563](http://arxiv.org/abs/math.AT/0603563))
...
* [[Pavol Å evera]], _[[Some title containing the words "homotopy" and "symplectic", e.g. this one]]_, based on a talk at "Poisson 2000", CIRM Marseille, June 2000; ([arXiv:0105080](http://arxiv.org/abs/math/0105080))
...
* [[Domenico Fiorenza]], [[Hisham Sati]], [[Urs Schreiber]], _[[schreiber:7d Chern-Simons theory and the 5-brane|Multiple M5-branes, String 2-connections, and 7d nonabelian Chern-Simons theory]]_, Advances in Theoretical and Mathematical Physics, Volume 18, Number 2 (2014) p. 229â€“321
...
* [[Domenico Fiorenza]], [[Chris Rogers]], [[Urs Schreiber]], _[[schreiber:L-âˆž algebras of local observables from higher prequantum bundles ]]_, Homology, Homotopy and Applications, Volume 16 (2014) Number 2, p. 107 â€“ 142 ([arXiv:1304.6292](http://arxiv.org/abs/1304.6292))
...
[[!redirects L-infinity algebras]]
[[!redirects L-âˆž algebra]]
[[!redirects L-âˆž algebras]]
[[!redirects L-âˆž-algebra]]
[[!redirects L-âˆž-algebras]]

[[!redirects âˆž-Lie algebra]]
[[!redirects âˆž-Lie-algebra]]
[[!redirects âˆž-Lie algebras]]
[[!redirects âˆž-Lie-algebras]]
