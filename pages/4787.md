...
The following notions of dimension capture aspects of the concept for objects in a [[topos]] or more generally an [[(âˆž,1)-topos]]:
...
A general abstract [[(âˆž,1)-topos theory|(âˆž,1)-topos theoretic]] discusssion of notions of homotopy/cohomology/covering _dimension_ is in section 7.2 of 
