...
For the analogous statement in [[(âˆž,1)-category]] theory see
...
at [[(âˆž,1)-category of (âˆž,1)-presheaves]].
...
For a proof see at [[(âˆž,1)-limit]]  _[here](limit+in+a+quasi-category#InOvercategories)_.
