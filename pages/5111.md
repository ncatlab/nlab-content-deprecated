...
More generally, we have the first half of the Eilenberg-Watts theorem in [[(âˆž,1)-category theory]]:

+-- {: .num_prop }
###### Proposition

For $(\mathcal{C}, \otimes)$ a [[monoidal (âˆž,1)-category]] with [[geometric realization]] of [[simplicial objects in an (âˆž,1)-category]] such that the [[tensor product]] $\otimes$ preserves this in each variable, then for all [[A-âˆž algebra]] $A,B,C$ in $\mathcal{C}$, the tensor product of [[âˆž-bimodules]] 

$$
  (-) \otimes_B (-) \;\colon\; {}_A Mod_{B} \times {}_B Mod_{C} \to {}_{A} Mod_{C}
$$

preserves [[(âˆž,1)-colimits]] separately in each argument.
...
* Charles E. Watts, _Intrinsic characterizations of some additive functors_,  Proc. Amer. Math. Soc. __11__, 1960, 5â€“8, [MR0806.0832](http://www.ams.org/mathscinet-getitem?mr=0806.0832), [doi](http://dx.doi.org/10.2307/2032707)
 {#Watts}

* [[Samuel Eilenberg]], _Abstract description of some basic functors_, 
J. Indian Math. Soc. (N.S.) __24__, 1960, 231â€“234 (1961), [MR0125148](http://www.ams.org/mathscinet-getitem?mr=0125148)
 {#Eilenberg}
