...
a one-parameter family of [[quantum states]], the [[SchrÃ¶dinger equation]] for this state reads
...
It is easy to solve this [[differential equation]] formally via its [[Green function]]: for $\vert \psi \rangle \in \mathcal{H}$ any state, then the unique solution $\vert \psi(-) \rangle$ to the SchrÃ¶dinger equation subject to $\vert \psi(0) \rangle = \vert \psi \rangle$ is
...
(One says that this is the solution "in the [[SchrÃ¶dinger picture]]", whence the subscript.)
...
is sufficiently well understood. The "[[interaction picture]]" is a way to decompose the SchrÃ¶dinger equation such that its dependence on $V$ gets separated from its dependence on $H_{free}$ in a way that admits to treat $H_{int}$ in [[perturbation theory]].
...
in ([Brunetti-Fredenhagen 99, section 3](#BrunettiFredenhagen99), [DÃ¼tschFredenhagen 04, appendix E](#DuetschFredenhagen04),
...
Review includes ([DÃ¼tsch-Fredenhagen 00, around (17)](#DuetschFredenhagen00)).
...
Direct axiomatization of the retarded products is due to ([DÃ¼tsch-Fredenhagen 04](#DuetschFredenhagen04)),
...
1. The transformations $Z \colon \mathcal{T}_{loc} \to \mathcal{T}_{loc}$ form a [[group]], called the
   _[[StÃ¼ckelberg-Peterson renormalization group]]_. Hence the renormalization schemes / coherent perturbative
...
([DÃ¼tsch-Fredenhagen 00, section 3](#DuetschFredenhagen00), following [Brunetti-Fredenhagen 99, section 8](#BrunettiFredenhagen99),
...
([DÃ¼tsch-Fredenhagen 00, below (17)](#DuetschFredenhagen00))
...
see at _[[Haagâ€“Lopuszanskiâ€“Sohnius theorem]]_
...
> In the 1970s, S-matrix theory just plain died. All practitioners jumped ship rapidly in 1974, with the triple-whammy of [[effective field theory|Wilsonian field theory]], the discovery of the Charm [[quark]], and [[asymptotic freedom]]. These results killed S-matrix theory for thirty years. Those that jumped ship include all the original [[string theory|string theorists]] who stayed employed: notably [[Gabriele Veneziano|Veneziano]], who was convinced that [[gauge theory]] was right when [[Gerard â€™t Hooft|t'Hooft]] showed that [[AdS-CFT|large-N gauge fields]] give the string topological expansion, and [[Leonard Susskind|Susskind]], who didn't mention Regge theory after the early 1970s. Everybody stopped studying [[string theory]] except [[JoÃ«l Scherk|Scherk]] and [[John Schwarz|Schwarz]], and Schwarz was protected by
...
* [[Coleman theorem]], [[Haagâ€“ÅopuszaÅ„skiâ€“Sohnius theorem]]
...
* {#Heisenberg43} [[Werner Heisenberg]], Zeitschrift fÃ¼r Physik 120, 513, 1943
...
based on ideas due to ([StÃ¼ckelberg 49](causal+perturbation+theory#Stueckelberg49), [StÃ¼ckelberg 51](causal+perturbation+theory#Stueckelberg49)) and
...
* {#Scharf95} [[GÃ¼nter Scharf]], sections 0.3 and 3.1 of _[[Finite Quantum Electrodynamics -- The Causal Approach]]_, Springer 1995

* [[GÃ¼nter Scharf]], section 2 of _[[Quantum Gauge Theories -- A True Ghost Story]]_, Wiley 2001
...
* {#DuetschFredenhagen00} [[Michael DÃ¼tsch]], [[Klaus Fredenhagen]], _Algebraic Quantum Field Theory, Perturbation Theory, and the Loop Expansion_, Commun.Math.Phys. 219 (2001) 5-30 ([arXiv:hep-th/0001129](https://arxiv.org/abs/hep-th/0001129))
...
* {#DuetschFredenhagen04} [[Michael DÃ¼tsch]], [[Klaus Fredenhagen]], _Causal perturbation theory in terms of retarded products, and a proof of the Action Ward Identity_, Rev. Math. Phys. 16, 1291 (2004) ([arXiv:hep-th/0403213](https://arxiv.org/abs/hep-th/0403213))
