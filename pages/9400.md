...
There is an evident generalization of the definition to [[higher category theory|higher categories]], and in particular to [[(âˆž,1)-categories]].  In the latter case, van Kampen colimits exactly characterize descent.  In particular,we have:

* A [[locally presentable (âˆž,1)-category]] is an [[(âˆž,1)-topos]] just when *all* colimits are van Kampen.
...
* [[exactness property]]
* [[object classifier in an (âˆž,1)-topos]]
