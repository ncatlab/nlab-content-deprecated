...
A _symmetric monoidal $(\infty,n)$-category_ is the analog of a [[symmetric monoidal (âˆž,1)-category]] for [[(âˆž,n)-category]] theory.
...
for any symmetric monoidal [[(âˆž,n)-category with duals]] $D$ and any symmetric monoidal functor $F : D \to C$ there exists a symmetric monoidal functor $f : D \to C^{fd}$, unique up to equivalence, and an equivalence
...
* For all $n \in \mathbb{N}$, the [[(âˆž,n)-category of cobordisms]] $Bord_n$ is symmetric monoidal. By the [[cobordism hypothesis]] this should be the [[free functor|free]] [[symmetric monoidal (âˆž,n)-category]] [[(âˆž,n)-category with duals|with duals]] on the [[point]].

* For all $n$ and $C$ any symmetric monoidal $(\infty,n)$-category, there is a symmetric monoidal [[(âˆž,n)-category of spans]] of [[âˆž-groupoid]]s over $C$.
...
* [[monoidal category]], [[monoidal (âˆž,1)-category]]
  ...
  * [[symmetric monoidal category]], [[symmetric monoidal (âˆž,1)-category]], **symmetric monoidal $(\infty,n)$-category** 

  * [[closed monoidal category]] ,  [[closed monoidal (âˆž,1)-category]]
...
[[!redirects symmetric monoidal (âˆž,n)-category]]
[[!redirects symmetric monoidal (âˆž,n)-categories]]

[[!redirects monoidal (âˆž,n)-category]]
[[!redirects monoidal (infinity,n)-category]]
[[!redirects monoidal (âˆž,n)-categories]]
