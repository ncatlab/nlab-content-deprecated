...
* A. Heyting , _Bemerkungen zu dem Aufsatz von Herrn Freudenthal â€œZur intuitionistischen Deutung logischer Formelnâ€_ , Comp. Math. **4** (1937) pp.117-118. ([pdf](http://archive.numdam.org/article/CM_1937__4__117_0.pdf))
...
* E. G. F. DÃ­ez, _Five observations concerning the intended meaning of the intuitionistic logical constants_ , J. Phil. Logic **29** no. 4 (2000) pp.409â€“424 . ([preprint](https://webs.um.es/picazo/miwiki/lib/exe/fetch.php?id=inicio&cache=cache&media=five_observations_2000_jour_of_phil_logic_29_4_pp409_424.pdf))

* [[Jean-Yves Girard]] et al., _Proofs and Types_ , CUP 1989.

* [[Anne Sjerp Troelstra]], _Principles of Intuitionism_ , Springer Heidelberg 1969. (Â§2) {#Troelstra69}
...
* [[Robert Harper]], _Extensionality, Intensionality, and Brouwerâ€™s Dictum_ ([web](http://existentialtype.wordpress.com/2012/08/11/extensionality-intensionality-and-brouwers-dictum/))


[[!redirects Brouwer Heyting Kolmogorov interpretation]] 
[[!redirects Brouwer-Heyting-Kolmogorov interpretation]] 
[[!redirects Brouwerâ€“Heytingâ€“Kolmogorov interpretation]] 
