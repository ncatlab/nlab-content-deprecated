...
By construction ([here](Atiyahâ€“Hirzebruch+spectral+sequence#ConstructionByFilteringTheBaseSpace)) the differentials are those induced by the [[exact couple]]
...
In particular every [[E-âˆž ring]] is a [[ring spectrum]], hence represents a multiplicative cohomology theory, but the converse is in general false.
