...
Moreover, there can also not be an [[(âˆž,1)-functor]] $Ab\rightarrow L_{whe} Top$ that lifts $M(-,n)$ since this will similarly yield an $\infty$-functor $Ab^G\rightarrow Top^{hG}$ where $Top^{hG}$ is the [[(âˆž,1)-category]] of [[âˆž-actions]] of $G$ on spaces. Since there is a "rigidification" functor $Top^{hG}\rightarrow Top^G$ this would yield an (ordinary) functor $Ab^G\rightarrow Top^G$ which does not exist by our previous observation. 
...
Co-Moore spaces are the [[Eckmann-Hilton duality|Eckmannâ€“Hilton duals]] of [[Eilenbergâ€“Mac Lane spaces]]. 
...
* [[Marek Golasinski]] and Gon&ccedil;alves, [On Co-Moore Spaces](http://www.mscand.dk/article.php?id=146)
...
Invent. Math. 64 (1981), no. 1, 171â€“174. 
