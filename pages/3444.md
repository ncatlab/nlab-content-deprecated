...
In the context of [[homotopy theory]] and [[higher category theory]] there are analogous definitions of [[âˆž-representations]]. 

For $G$ an [[âˆž-group]] and $\mathbf{B}G$ its [[delooping]] [[âˆž-groupoid]], an $\infty$-representation on objects of some [[(âˆž,1)-category]] $D$ (such as that of [[(âˆž,n)-vector spaces]] is the [[(âˆž,1)-category of (âˆž,1)-functors]]
...
If $D  \simeq$ [[âˆžGrpd]] this are [[âˆž-permutation representations]] and by the [[(âˆž,1)-Grothendieck construction]] any such corresponds to an [[associated âˆž-bundle]]

$$
  V \to V//G \to \mathbf{B}G
$$

over $\mathbf{B}G$ in such a way that we have an [[equivalence of (âˆž,1)-categories]]
...
with the [[over-(âˆž,1)-category]] of [[âˆž-groupoids]] over $\mathbf{B}G$.

This way of looking at categories of representations generalizes to every [[(âˆž,1)-topos]] $\mathbf{H}$ of [[homotopy dimension]] 0.
...
The assumption that $\mathbf{H}$ has [[homotopy dimension]] 0 guarantees that the homotopy fiber exists (since a global point $* \to \mathbf{B}G$ exists) and is well defined up to [[equivalence in an (âˆž,1)-category]].
...
* Theodor BrÃ¶cker, Tammo tom Dieck, _Representations of compact Lie groups_ Graduate Texts in Mathematics, Springer (1985)
