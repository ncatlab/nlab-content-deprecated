...
Similarly a [[differentiable stack]] is called an _effective Ã©tale stack_ if it is represented by an effective Ã©tale Lie groupoid.
...
1. the canonical smooth [[functor]] $X_\bullet \to \mathbb{H}(X_0)$ (see [here](Ã©tale+groupoid#RelationToHaefligerGroupoids)) to the [[Haefliger groupoid]] of the manifold of objects is [[faithful functor|faithful]], i.e. gives a [[representable morphism of stacks]];

1. under the equivalence ([here](Ã©tale+groupoid#CharacterizationBySiteOfManifolds)) between smooth Ã©tale stacks and stacks on the [[site]] $SmthMfd^{et}$ of smooth manifolds with [[local diffeomorphisms]] between them, $X$ corresponds to a [[sheaf]] (i.e. to a [[0-truncated]] stack) on $SmthMfd^{et}$.
...
* [[proper Lie groupoid]], [[Ã©tale groupoid]]

## References

A standard textbook aacount is in

* [[Ieke Moerdijk]], Janez Mr&ccaron;un _Introduction to Foliations and Lie Groupoids_ ,Cambridge Studies in Advanced Mathematics 91, Cambridge University Press, Cambridge, (2003)

Brief survey is in 

* [[David Carchedi]], _A quick note on Ã©tale stacks_ ([pdf](http://people.mpim-bonn.mpg.de/carchedi/Etale_Stacks.pdf))

Discussion in a more general context of [[Ã©tale stacks]] is in

* {#Carchedi12} [[David Carchedi]], _Ã‰tale Stacks as Prolongations_ ([arXiv:1212.2282](http://arxiv.org/abs/1212.2282))