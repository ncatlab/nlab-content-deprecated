...
As the notation suggests, thus formulating the theory in [[(2,1)-topos]] theory immediately generalizes it to [[(âˆž,1)-topos theory]]. This is discussed at _[[principal âˆž-bundle]]_.
...
Let $H$ be the suitable [[(âˆž,1)-topos]] internal to which one looks at $G$-principal bundles. For instance for topological bundles this would be [[Top]]. For smooth bundles it would be the [[(âˆž,1)-category of (âˆž,1)-sheaves]] on [[Diff]], etc. 
...
(with an eye towards its generalization to [[principal âˆž-bundles]]).
...
be the [[quotient object|effective]] [[groupoid object in an (âˆž,1)-category]] that exhibits the [[delooping]] $\mathbf{B}G$ of $G$.
...
* and it exhibits $P \times G^{\times (n-1)}$ as the [[groupoid object in an (âˆž,1)-category]] being the [[ÄŒech nerve]] of $P \to X$:
...
in [[ÄŒech cohomology]] coming from some [[cover]] $\{U_i \to X\}$ of $X$.

The [[ÄŒech nerve]] $C(U)$ has
...
for $g_{i j} \in Functions(U_{i j}, G)$ as described in detail at [[ÄŒech cohomology]].
...
* {#Cartan} _S&eacute;minaire [[Henri Cartan]]_ 1949-1950 ([numdam](http://www.numdam.org/numdam-bin/browse?id=SHC_1948-1949__1_))
...
* {#Husemoeller} [[Dale HusemÃ¶ller]], _Fiber bundles_, Springer (1994) 
...
* [[Tomasz BrzeziÅ„ski]], _On synthetic interpretation of quantum principal bundles_, AJSE D - Mathematics 35(1D): 13-27, 2010 [arxiv:0912.0213](http://uk.arxiv.org/abs/0912.0213)
...
* Takashi Karube, _On the local cross-sections in locally compact groups_, J. Math. Soc. Japan 10 (1958) 343â€“347 ([Euclid](http://projecteuclid.org/euclid.jmsj/1261148669))
 {#Karube}
...
* Christoph MÃ¼ller, [[Christoph Wockel]], _Equivalences of smooth and continuous principal bundles with infinite-dimensional structure groups_, Advances in Geometry. Volume 9, Issue 4, Pages 605â€“626 (2009)
