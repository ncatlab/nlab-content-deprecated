...
* [[G. M. Kelly]], _Chain maps inducing zero homology maps_, Proc. Cambridge Philos. Soc. 61 (1965), 847â€“854,

whilst their modern development can be traced to

*  [[A. I. Bondal]], [[Mikhail Kapranov]], _Enhanced triangulated categories_, ÐœÐ°Ñ‚ÐµÐ¼. Ð¡Ð±Ð¾Ñ€Ð½Ð¸Ðº, Ð¢Ð¾Ð¼ 181 (1990), No.5, 669--683 (Russian); transl. in USSR Math. USSR Sbornik, vol. 70 (1991), No. 1, pp. 93--107, (MR91g:18010) ([[bondalKaprEnhTRiangCat.pdf:file]])
...
* [[Bernhard Keller]], _On differential graded categories_  International Congress of Mathematicians. Vol. II,  151--190, Eur. Math. Soc., ZÃ¼rich, 2006. ([arXiv](http://arxiv.org/abs/math/0601185))

and

* [[Bertrand ToÃ«n]], _Lectures on dg-categories_ ([pdf](https://perso.math.univ-toulouse.fr/btoen/files/2012/04/swisk.pdf)).

### Homotopy theory of dg-categories

The [[homotopy theory]] of [[dg-categories]] is studied in

* [[GonÃ§alo Tabuada]], _Homotopy theory of DG categories_, Thesis, Paris, 2007, [pdf](http://people.math.jussieu.fr/~keller/TabuadaThese.pdf).

* [[GonÃ§alo Tabuada]], _Une structure de catÃ©gorie de modÃ¨les de Quillen sur la catÃ©gorie des dg-catÃ©gories_,  C. R. Math. Acad. Sci. Paris  340  (2005),  no. 1, 15--19.
...
* [[GonÃ§alo Tabuada]], _Invariants additifs de DG-catÃ©gories_, Int. Math. Res. Not.  2005,  no. 53, 3309--3339; Addendum in Int. Math. Res. Not.  2006, Art. ID 75853, 3 pp. ; Erratum in Int. Math. Res. Not. IMRN  2007,  no. 24, Art. ID rnm149, 17 pp.

* [[Marco Robalo]], _ThÃ©orie homotopique motivique des espaces noncommutatifs_, [pdf](http://webusers.imj-prg.fr/~marco.robalo/these.pdf).
...
* [[Bernhard Keller]], _Deriving DG categories_,  Ann. Sci. Ã‰cole Norm. Sup. (4)  27  (1994),  no. 1, 63--102 (<a href="http://www.numdam.org/item?id=ASENS_1994_4_27_1_63_0">numdam</a>)
