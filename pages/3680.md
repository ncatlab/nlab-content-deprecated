...
The notion of **final $(\infty,1)$-functor** (also called a **cofinal $(\infty,1)$-functor**) is the generalization of the notion of [[final functor]] from [[category theory]] to [[(âˆž,1)-category]]-theory.

An [[(âˆž,1)-functor]] $p : K' \to K$ is final precisely if precomposition with $p$ preserves [[colimit]]s: 

if $p$ is final then for for $F : K \to C$ any [[(âˆž,1)-functor]] we have
...
* ... and for every $F : K \to C$ the morphism
  ...
  of [[over quasi-category|under quasi-categories]] induced by composition with $p$ is an equivalence of [[(âˆž,1)-categories]].
...
The inclusion $\ast \to \mathcal{C}$ of a [[terminal object in an (âˆž,1)-category|terminal object]] is final.
...
By theorem \ref{Recognition} the inclusion of the point is final precisely if for all $c \in \mathcal{C}$, the [[(âˆž,1)-categorical hom-space]] $\mathcal{C}(c,\ast)$ is contractible. This is the definition of $\ast$ being terminal.
...
[[!redirects cofinal (âˆž,1)-functor]]
[[!redirects cofinal (infinity,1)-functors]]
[[!redirects cofinal (âˆž,1)-functors]]
[[!redirects final (infinity,1)-functor]]
[[!redirects final (âˆž,1)-functor]]
[[!redirects final (infinity,1)-functors]]
[[!redirects final (âˆž,1)-functors]]
[[!redirects initial (infinity,1)-functor]]
[[!redirects initial (âˆž,1)-functor]]
[[!redirects initial (infinity,1)-functors]]
[[!redirects initial (âˆž,1)-functors]]
