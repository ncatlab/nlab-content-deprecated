...
####The PoincarÃ© Group
The universal covering $SL(2, \C) \ltimes \R^4$ of the restricted [[PoincarÃ© group]] $\mathcal{P}^{\dagger}_+$ will be denoted by $\mathcal{P}$, the [[abelian group|abelian]] [[subgroup]] of all translations by $\mathcal{T}$.
...
* Hellmut BaumgÃ¤rtel: Operator algebraic Methods in Quantum Field Theory. A series of lectures. Akademie Verlag 1995 ([ZMATH entry] (http://www.zentralblatt-math.org/zmath/en/advanced/?q=an:0839.46063&format=complete))

A secondary reference is this:

* Hellmut BaumgÃ¤rtel, Manfred Wollenberg: Causal nets of operator algebras, Berlin: Akademie Verlag 1992 ([ZMATH entry] (http://www.zentralblatt-math.org/zmath/en/advanced/?q=an:0749.46038&format=complete))