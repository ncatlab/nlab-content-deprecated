...
This [[Dirac structure]] was first observed in ([Å evera-Weinstein](#SeveraWeinstein)). The name "Cartan-Dirac structure" was introduced in ([BCWZ](#BCWZ)).

## References

The Cartan-dirac structure appears first as example 4.2 in 

* [[Pavol Å evera]], [[Alan Weinstein]], _Poisson geometry with a 3-form background_ ([arXiv:math/0107133](http://arxiv.org/abs/math/0107133))
 {#SeveraWeinstein}
