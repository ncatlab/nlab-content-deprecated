...
This refines to a morphism of [[âˆž-groups]]

$$
  J \;\colon\; O \longrightarrow GL_1(\mathbb{S})
$$

from the [[stable orthogonal group]] (regarded as a [[group object in an (âˆž,1)-category|group object]] in $L_{whe} Top \simeq$ [[âˆžGrpd]])
to the [[âˆž-group of units]] of the [[sphere spectrum]], regarded as an [[E-âˆž ring spectrum]].
...
sends real [[vector bundles]] to [[sphere bundles]], namely to [[(âˆž,1)-line bundles]] with typical [[fiber]] the [[sphere spectrum]] $\mathbb{S}$. See also at _[[Thom space]]_ for more on this.
...
1. its [[homotopy type]] $\Pi(S^n) \in L_{whe} Top \simeq$ [[âˆžGrpd]] given by its [[fundamental âˆž-groupoid]].

Similarly we write $\Pi(O(n))$ for the [[homotopy type]] of the [[orthogonal group]], regarded as a [[group object in an (âˆž,1)-category]] in [[âˆžGrpd]] (using that the [[shape modality]] $\Pi$ preserves [[finite products]]).

+-- {: .num_defn #AutoequivalencesOfnSphere}
###### Definition

For $n \in \mathbb{N}$ write $H(n)$ for the [[automorphism âˆž-group]] of homotopy self-equivalences $S^n \longrightarrow S^n$, hence
...
The [[âˆž-group]] $H(n)$, def. \ref{AutoequivalencesOfnSphere}, constitutes the two [[connected components]] of the $n$-fold based [[loop space]] $\Omega^n S^n$ corresponding to  the [[homotopy groups]] $\pm 1 \in \pi_n(S^n)$.
...
induces a homomorphism of [[âˆž-groups]] of the form
...
are [[âˆž-group]] [[homomorphisms]], there exists their [[delooping]]
...
Here $GL_1(\mathbb{S})$ is the [[âˆž-group of units]] of the [[sphere spectrum]].
...
Discussion in [[higher algebra]] in term of [[(âˆž,1)-module bundles]] is in
...
* [[Daniel Quillen]], _The Adams conjecture_, Topology. an International Journal of Mathematics 10: 67â€“80 (1971) ([pdf](http://math1.unice.fr/~cazanave/Gdt/ImJ/Quillen.pdf))
 {#Quillen71}


* [[Dennis Sullivan]], _Genetics of homotopy theory and the Adams conjecture_, Ann. of Math. 100 (1974), 1â€“79.
 {#Sullivan74}

* [[Robert Switzer]], _Algebraic topologyâ€“homotopy and homology_, Springer-Verlag, New York, 1975.
 {#Switzer75}
...
Similarly there is a canonical $O(n)$-[[âˆž-action]] on an [[n-fold loop space]], not just on the [[sphere spectrum]]. But the general case is closely related to the J-homomorphism. Discussion includes

* {#GaudensMenichi07} Gerald Gaudens, [[Luc Menichi]],  section 5 of _Batalin-Vilkovisky algebras and the $J$-homomorphism_, Topology and its Applications Volume 156, Issue 2, 1 December 2008, Pages 365â€“374 ([arXiv:0707.3103](http://arxiv.org/abs/0707.3103))
