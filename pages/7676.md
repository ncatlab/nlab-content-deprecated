[[!redirects I.8, constant- and ̩tale schemes]]
...
An _̩tale $k$-scheme_ is defined to be a directed colimit of $k$-spectra $Sp_k k^\prime$ of finite separable field-extensions $k^\prime$ of $k$.


An _̩tale formal $k$-scheme_ is defined to be a directed colimit of formal $k$-spectra $Spf_k k^\prime$ of finite separable field-extensions $k^\prime$ of $k$.
...
+-- {: .num_prop}
###### Proposition
Let $X$ be a $k$-formal scheme (resp. a [[locally algebraic scheme]]) then $X$ is [[etale scheme|̩tale]] iff the [[Frobenius morphism]] $F_X:X\to X^{(p)}$is a monomorphism (resp. an isomorphism).
=--
...
from [[etale scheme|̩tale schemes]] to the category of [[Galois module|Galois modules]] $Gal(k_s/s)-Mod$ is an equivalence of categories.
=--
