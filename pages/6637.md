...
This perspective generalizes to the notion of [[outer automorphism âˆž-group]].

## Examples

The connected components of the [[subgroup]] of outer automorphisms of the a [[super PoincarÃ© group]] which fixes the underlying [[PoincarÃ© group]] is known as the _[[R-symmetry group]]_ in [[supersymmetry]].
