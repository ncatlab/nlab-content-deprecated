...
imp_monoidal=""
imp_adj="Kolmogorov-Quotient+Embedding of \(\mathbf{Top\}_0\); Stone-ÄŒech-Compactification+Embedding of \(\mathbf{Comp\}\); forgetful functor+discrete topology; indiscrete topology+forgetful functor"
imp_equ=""
Mono=Injections
Epi=Surjections
Ext-Mono=Embeddings
