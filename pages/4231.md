...
=--
([Cisinski 02, ThÃ©orÃ¨me 4.8](#Cisinski02))

We can use this to prove that a [[locally presentable (âˆž,1)-category]] is [[locally cartesian closed (âˆž,1)-category]] if and only if it has a presentation by a right proper Cisinski model structure.  See [[locally cartesian closed (âˆž,1)-category]] for details.
...
* [[Denis-Charles Cisinski]] , _ThÃ©ories homotopiques
dans les topos_, JPAA, Volume 174 (2002), p.43-82
 {#Cisinski02}

* [[Denis-Charles Cisinski]], _[[joyalscatlab:Les prÃ©faisceaux comme modÃ¨les des types d'homotopie]]_, AstÃ©risque, Volume 308, Soc. Math. France (2006), 392 pages ([pdf](http://www.math.univ-toulouse.fr/~dcisinsk/ast.pdf))
 {#Cisinski06}
...
* [[AndrÃ© Joyal]], _[[joyalscatlab:Cisinski's theory]]_
