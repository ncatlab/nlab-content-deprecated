...
* The only Banach division algebra over $\mathbb{C}$ is $\mathbb{C}$ itself, by the [[Gelâ€™fandâ€“Mazur theorem]].

* A $JB$-[[JB-algebra|algebra]] (or more generally a [[Jordanâ€“Banach algebra]]) is a nonassociative (but commutative) kind of Banach algebra.  (The commutative associative Banach algebras also count as Jordan--Banach algebras.)
...
* {#BoschGuntzerRemmert84} [[Siegfried Bosch]], [[Ulrich GÃ¼ntzer]], [[Reinhold Remmert]], section 3.7 of _[[Non-Archimedean Analysis]] -- A systematic approach to rigid analytic geometry_, 1984 ([pdf](http://math.arizona.edu/~cais/scans/BGR-Non_Archimedean_Analysis.pdf))
