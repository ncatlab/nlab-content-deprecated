...
Even more generally, the notion of a [[connection on a bundle]] and of a [[Lie algebra]]-valued 1-form generalizes to connections on [[principal 2-bundle]]s and [[principal âˆž-bundle]]s and [curvature of âˆž-Lie algebroid valued differential forms](#OfInfLieAlgebroidValuedForms). 
...
* According to the discussion at [[âˆž-Chern-Weil theory]], a connection on a trivial [[principal âˆž-bundle]] is given by a collection of [[âˆž-Lie algebroid valued differential forms]]. The notion of curvature in this general context is discussed at [curvature of âˆž-Lie algebroid valued differential forms](#OfInfLieAlgebroidValuedForms).
...
it is useful to recall that both the [[deRham complex]] $\Omega^\bullet(X)$ as well as the [[Chevalley-Eilenberg algebra]] $CE(\mathfrak{g})$ are naturally interpreted as function algebras on [[infinitesimal object]]s, as discussed at [[âˆž-Lie algebroid]].

The [[deRham complex]] may be thought of as the algebra of functions on the infinitesimal path âˆž-groupoid $\Pi^{inf}(X)$. This has as [[object]]s the points of $X$, as [[morphism]]s [[infinitesimal object|infinitesimal]] paths
...
The notion of curvature of a [[Lie-algebra valued 1-form]] discussed [above](#OfLieAlgebraValuedForm) generalizes to that of [[âˆž-Lie algebroid valued differential forms]].

### Definition

Let $\mathfrak{g}$ be an [[âˆž-Lie algebra]]. A $\mathfrak{g}$-valued differential form on a [[smooth manifold]] $X$ is a morphism
...
If instead of just an $\infty$-Lie algebra $\mathfrak{g}$ we take more generally an [[âˆž-Lie algebroid]], then there is also a **1-form curvature component**.
