...
A [[chain complex]] in non-negative degree is, under the [[Dold-Kan correspondence]] a [[homological algebra]] model for a particularly nice [[topological space]] or [[âˆž-groupoid]]: namely one with an abelian group structure on it, a [[simplicial abelian group]].
...
induced by the Dold-Kan [[nerve]] is that it allows to think of [[chain complexes]] as objects in the [[(âˆž,1)-topos]] [[âˆžGrpd]] or equivalently [[Top]]. Every [[(âˆž,1)-topos]] comes with a notion of [[homotopy]] and [[cohomology]] and so such abstract notions get induced on chain complexes.
...
This entry describes how these standard definition of chain homology and cohomology follow from the general [[(âˆž,1)-topos]] nonsense described at [[cohomology]] and [[homotopy]]. 
...
In a given [[(âˆž,1)-topos]] there is a notion of [[homotopy]] and [[cohomology]] for every (co-)coefficient object $A$ ($B$).
...
chain complexes into [[âˆž-groupoids]], for any chain complexes $X_\bullet$, $A_\bullet$ and $B_\bullet$ we obtain 
...
[[stable (âˆž,1)-category|stable (âˆž,1)-]] [[category of chain complexes]].
