...
The [[HomePage|nLab]] is a _collaborative [wiki](http://en.wikipedia.org/wiki/Wiki)_.  It grew out of the desire ([I](http://golem.ph.utexas.edu/category/2007/09/towards_a_higherdimensional_wi.html), [II](http://golem.ph.utexas.edu/category/2008/11/beyond_the_blog.html)) to have a place for development (the "Lab" in â€œ$n$Labâ€) and indexed archives of the ideas and concepts surrounding the discussions at the [The $n$-Category CafÃ©](http://golem.ph.utexas.edu/category/).  These discussions primarily are about [[mathematics]], [[physics]] and [[philosophy]] from the perspective of [[category theory]] and [[higher category theory]] (the â€œ$n$â€ in â€œ$n$Labâ€ and [[nPOV]]).

The $n$Lab was [created](http://golem.ph.utexas.edu/category/2008/11/nlab.html) in November 2008 using software provided and set up by [[Jacques Distler]].  The name â€œ$n$Labâ€ (short for â€œ$n$-Category Labâ€, but perhaps less restrictive) was dreamt up by Lisa Raphals ([[John Baez]]'s wife).
