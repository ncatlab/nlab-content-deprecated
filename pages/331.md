...
Generally, [[(âˆž,1)-category theory]], which is about untruncated objects, is the home for logic and types with a [[constructive mathematics|constructive]] notion of [[equality]], the [[identity types]] in [[homotopy type theory]].
...
* {#HilbertAckermann59} [[David Hilbert]], [[Wilhelm Ackermann]], _GrundzÃ¼ge der Theoretischen Logik_ , 4th ed. Springer Heidelberg 1959 [1928]
...
* [[Pierre Cartier]], _Logique, catÃ©gories et faisceaux_, SÃ©minaire Bourbaki, 20 (1977-1978), Exp. No. 513, 24 p. ([numdam]( http://www.numdam.org/item?id=SB_1977-1978__20__123_0))
