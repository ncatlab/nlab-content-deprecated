...
* 1-monomorphisms are often just called [[monomorphisms in an (âˆž,1)-category]]. The 1-monomorphisms into a fixed object are called the [[subobject in an (âˆž,1)-category|subobjects]] of that object.
