...
A [[sheaf of spectra]] on the [[site]] of all [[smooth manifolds]] may be thought of as a [[spectrum]] equipped with generalized [[smooth structure]], in just the same way as an [[(âˆž,1)-sheaf]] on this site may be thought of as a [[smooth âˆž-groupoid]]. Therefore one might speak of the [[stable (âˆž,1)-category]]
...
which is the [[stabilization]] of that of [[smooth âˆž-groupoids]] as being the $\infty$-category of _smooth spectra_, just as the [[stable (âˆž,1)-category of spectra]] itself is the [[stabilization]] of that of bare [[âˆž-groupoids]].

Together with [[smooth âˆž-groupoids]] smooth spectra sit inside the [[tangent cohesive (âˆž,1)-topos]] over smooth manifolds. By the discussion [there](tangent+cohesive+âˆž-topos#CohesiveAndDifferentialRefinement), every smooth spectrum sits in a hexagonal [[differential cohomology diagram]] which exhibits it ([Bunke-Nikolaus-VÃ¶lkl 13](#BunkeNikolausVoelkl13)) as the moduli of a generalized [[differential cohomology]] theory  (in generalization of how every ordinary spectrum, via the [[Brown representability theorem]], corresponds to a bare [[generalized (Eilenberg-Steenrod) cohomology theory]]).
...
Let $C_\bullet \in Ch_\bullet(\mathbf{R}Mod)$ be a [[chain complex]] (unbounded) of [[abelian sheaves]] of $\mathbf{R}$-modules. Via the projective [[model structure on functors]] this defines an [[(âˆž,1)-presheaf]] of [[chain complexes]]
...
We still write $C_\bullet\in PSh_\infty(SmthMfd, Ch_\bullet)$ for this [[(âˆž,1)-presheaf]] of chain complexes. 
...
a chain complex of $\mathbf{R}$-modules $C_\bullet \in Ch_\bullet(\mathbf{R}Mod)$, regarded as an [[(âˆž,1)-presheaf]] of spectra on $SmthMfd$ as in def. \ref{RModulesAsInfinityPresheaves}, is already an [[(âˆž,1)-sheaf]], hence a smooth spectrum (i.e. without further [[âˆž-stackification]]).

=--

This appears as ([Bunke-Nikolaus-VÃ¶lkl 13, lemma 7.12](#BunkeNikolausVoelkl13)).
...
Write $Ch_\bullet$ for the [[(âˆž,1)-category of chain complexes]] (of [[abelian groups]], hence over the [[ring]] $\mathbb{Z}$ of [[integers]]). It is convenient to choose for $A_\bullet \in Ch_\bullet$ the grading convention
