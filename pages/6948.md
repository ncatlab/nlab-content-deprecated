...
In [[logic]], the _universal quantifier_ â€œ$\forall$â€ is the [[quantifier]] used to express, given a [[predicate]] $\phi$ with a [[free variable]] $x$ of [[type]] $T$, the [[proposition]]
...
Universal quantification is essentially the restriction of the [[direct image]] [[right adjoint]] of a canonical [[Ã©tale geometric morphism]] $X_\ast$, 
...
The same makes sense, verbatim, also in the [[(âˆž,1)-logic]] of any [[(âˆž,1)-topos]].
...
* [[Bill Lawvere]] _Quantifiers and sheaves_, Actes, CongrÃ¨s intern, math., 1970. Tome 1, p. 329 Ã  334 ([pdf](http://www.mathunion.org/ICM/ICM1970.1/Main/icm1970.1.0329.0334.ocr.pdf))
