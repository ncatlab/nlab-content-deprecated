...
where $\sim$ is the equivalence relation given by $K \sim L$ if and only if $j(K = L)$ and $j$ is the [[Lawvereâ€“Tierney topology]] describing the subtopos $Sh(C) \hookrightarrow PSh(C)$.
...
Amer. J. Math. 84 1962 205â€“216, [MR144341](http://www.ams.org/mathscinet-getitem?mr=144341), [doi](http://dx.doi.org/10.2307/2372759)
