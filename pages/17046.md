...
is an isomorphism (or an equivalence in the case of âˆž-categories).
...
to be an isomorphism (or an equivalence in the case of âˆž-categories).  Note that here $i$ is an element of the [[functor category]] $I^J$, and $i(j)$ denotes its value at $j\in J$.
