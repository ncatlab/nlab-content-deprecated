...
Under the [[Dold-Kan correspondence]], [[âˆž-groupoids]] with strict abelian group structure (modeled by [[Kan complexes]] that are [[simplicial object|simplicial]] abelian groups) are identified with non-negatively graded [[chain complexes]] of abelian groups
...
The **homology groups** of a [[chain complex]] of abelian groups are the image under this identification of the [[homotopy groups]] of the corresponding [[âˆž-groupoids]]. More details on this are at [[chain homology and cohomology]].
...
where on the right we have the [[smash product of spectra]] with the [[suspension spectrum]] of $X$ and on the left we abbreviate this to the [[(âˆž,1)-colimit|(âˆž,1)-tensoring]] of [[Spec]] over [[Top]].
