...
This is entirely analogous to how a [[crossed complex]] is obtained from a [[strict Ï‰-groupoid]]. In fact it is a special case of that, as discussed at [[Dold-Kan correspondence]] in the section on the nonabelian version.
...
Typically one has pairings  $N G_p \times N G_q \to N G_{p+q}$. These use the [[ConduchÃ© decomposition theorem]], see the discussion at [[hypercrossed complex]].
...
* [[John Moore]], _Homotopie des complexes monoÃ¯daux, I._  SÃ©minaire Henri Cartan, 7 no. 2 (1954-1955), ExposÃ© No. 18, 8 p. ([numdam]( http://www.numdam.org/item?id=SHC_1954-1955__7_2_A8_0))
