...
For $(A, \cdot, \{-,-\})$ a Poisson algebra, $A$ together with its [[module]] $\Omega^1(A)$ of [[KÃ¤hler differential]]s naturally form a [[Lie-Rinehart pair]], with bracket given by
...
* [[Bertram Kostant]], _Quantization and unitary representations. I. Prequantization_, In _Lectures in Modern Analysis and Applications, III_, pages 87â€“208. Lecture Notes in Math., Vol. 170. Springer, Berlin (1970)
 {#Kostant}
