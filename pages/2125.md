...
This implies that generalized [[Eilenbergâ€“Mac Lane spectra]] on [[differential graded algebra|differential graded commutative algebras]] are [[E-k operad|E-infinity monoids]] in the category of $H \mathbb{Z}$-[[module]] [[spectrum|spectra]].
...
between connective dg-[[E-âˆž algebra]] over $k$ and simplicial $E_\infty$-algebras over $k$.
...
More precisely, for $X$ a [[topological space]] and $X^{\Delta^n_{Top}}$ the set of $n$-[[simplex|simplices]] in $X$, arranging themselves into the [[simplicial set]] $\Pi(X) = X^{\Delta^\bullet_{Top}}$ -- the [[fundamental âˆž-groupoid]] of $X$ -- and for $R$ some [[ring]] let $Maps(\Pi(X),R)$ be the cosimplicial ring of maps $X^{\Delta^n_{Top}} \to R$. 
...
* {#CastiglioniCortinas} J.L. Castiglioni, G. CortiÃ±as, _Cosimplicial versus DG-rings: a version of the Dold-Kan correspondence_ , J. Pure Appl. Algebra  191  (2004),  no. 1-2, 119--142, ([arXiv:math.KT/0306289](http://arxiv.org/abs/math/0306289))
...
* {#HinichSchechtman} [[Vladimir Hinich]], [[Vadim Schechtman]], _Homotopy limits of homotopy algebras_, in _K-theory: algebra, geometry, arithmetic_, Lecture Notes in Mathematics 1289,  Springer, Berlin 240 âˆ’ 264
...
* {#Fresse} [[Benoit Fresse]], _[Homotopy of Operads and Grothendieck-TeichmÃ¼ller Groups](http://math.univ-lille1.fr/~fresse/OperadHomotopyBook/)_, chapter 6: _Differential graded commutative algebras and cosimplicial algebras_ ([pdf](http://math.univ-lille1.fr/~fresse/OperadHomotopyBook/CommutativeAlgebraHomotopy.pdf))
...
* {#Mandell} [[Michael Mandell]], _Topological AndrÃ©-Quillen Cohomology and $E_\infty$ AndrÃ©-Quillen Cohomology_ Adv. in Math., Adv. Math. 177 (2) (2003) 227â€“279
...
* [[Pavol Å evera]], [[Thomas Willwacher]], _Equivalence of formalities of the little discs operad_, [arXiv:0905.1789](http://arxiv.org/abs/0905.1789)


[[!redirects monoidal Doldâ€“Kan correspondence]]
