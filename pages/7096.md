...
If $D$ is a [[divisor]] in $X$, then $c_1(\mathcal{O}_X(D))$ is the [[Poincar̩ duality|Poincar̩ dual]] of the [[fundamental class]] of $D$ (e.g. [Huybrechts 04, prop. 4.4.13](#Huybrechts04)).
