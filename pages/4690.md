...
> Indess mÃ¼ndet das Schlussresultat der letzten Einsteinschen Untersuchung wieder auf ein Hamiltonsches Prinzip, das dem ursprÃ¼nglich von mir aufgestellten gleicht; ja es kÃ¶nnte sein, dass diese Einsteinsche Theorie inhaltlich sich mit der von mir ursprÃ¼nglich aufgestellten Theorie vÃ¶llig deckt.

p. 405: 

> Als Entgelt dafÃ¼r kÃ¶nnen wir gegenwÃ¤rtig als sicher ansehen, dass die oben von mir aufgestellten Gl. gewiss den _Grundstock fÃ¼r die Weltgl._ ausmachen. In einer letzten vor wenigen Tagen erschienenen Note gelangt Einstein zu dem Hamiltonschen Prinzip:

> $\delta \int \int \int \int  \{K + \alpha \Phi + \beta \phi\} \sqrt{g} d x^1 d x^2 d x^3 d x^4 = 0$

> $[...]$

> Und wenn auf dem kollossalen Umweg Ã¼ber Levi Civita, Weyl, Schouten, Eddington Einst. zu dem Resultat zurÃ¼ckgelangt, so liegt darin sicher eine schÃ¶ne GewÃ¤hr.
...
* {#SauerMajer} [[Tilman Sauer]], [[Ulrich Majer]] with  Arne Schirrmacher, Heinz-JÃ¼rgen Schmidt (eds.), _David Hilbertâ€™s "Lectures on the foundations of physics"_, 1915-1927 : relativity, quantum theory and epistemology, Springer 2009
