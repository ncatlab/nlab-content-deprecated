...
In general, the term _symmetric monoidal_ is used for the maximally commutative case. See for instance [[symmetric monoidal (âˆž,1)-category]]. Notably, a symmetric monoidal [[âˆž-groupoid]] is, under the [[homotopy hypothesis]], the same as a [[spectrum|connective spectrum]].
...
* **symmetric monoidal category**, [[symmetric monoidal (âˆž,1)-category]], [[symmetric monoidal (âˆž,n)-category]] 
