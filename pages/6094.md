...
Let $\mathbf{S}$ be a [[good symmetric monoidal (âˆž,1)-category|good]] [[symmetric monoidal (âˆž,1)-category]]. Write $Alg(\mathbf{S})$ for the [[symmetric monoidal (âˆž,n)-category|symmetric monoidal (âˆž,2)-category]] whose [[object]]s are [[algebra in an (âˆž,1)-category|algebra objects]] in $\mathbf{S}$ and whose [[morphisms]] are [[bimodule]] objects. 
...
[[!redirects Calabi-Yau A-âˆž algebra]]
[[!redirects Calabi-Yau A-âˆž algebras]]