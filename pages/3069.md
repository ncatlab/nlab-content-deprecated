...
$$\array{ & \overset{f^*}{\to} & \\
  ...
  & \underset{h^*}{\to} & }$$
in which $f^*$ and $h^*$ have [[left adjoint]]s $f_!$ and $h_!$, respectively. (The classical example is a [[WirthmÃ¼ller context]].)  Then the [[natural isomorphism]] that makes the square commute 
...
According to the [[Benabouâ€“Roubaud theorem]], the Chevalley condition  is crucial for establishing the connection between the descent in the sense of fibered categories and the [[monadic descent]].
...
### Proper base change in Ã©tale cohomology

For [[coefficients]] of [[torsion group]], [[Ã©tale cohomology]]
...
* {#BenabouRoubaud} [[Jean BÃ©nabou]], [[Jacques Roubaud]], _Monades et descente_, C. R. Acad. Sc. Paris, t. 270 (12 Janvier 1970), Serie A, 96--98, ([link](http://gallica.bnf.fr/ark:/12148/bpt6k480298g/f100), BibliothÃ¨que nationale de France)
...
* {#Joyal} [[AndrÃ© Joyal]], _The Theory of Quasi-Categories and its Applications_ ([pdf](http://mat.uab.cat/~kock/crm/hocat/advanced-course/Quadern45-2.pdf))
...
[[!redirects Beckâ€“Chevalley property]]
[[!redirects Beck--Chevalley property]]
