...
[[formally smooth scheme]], [[formally ̩tale morphism]] and
...
* [[formally ̩tale morphism|formally ̩tale]] precisely if it is an $CAlg_k^{inf}$-sheaf in the sense of def. \ref{BareSheafCondition}, hence precisely if the canonical morphism
...
* [[formally ̩tale morphism|formally ̩tale]] precisely if it is an $Alg_k^{inf}$-sheaf in the sense of def. \ref{BareSheafCondition}, hence precisely if the canonical morphism
