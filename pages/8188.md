...
Specific sequence spaces are usually known through their symbolic names, such as â€˜$c_0$â€™ and â€˜$l^p$â€™, that appear below.  The term 'sequence space' is useful as a general name without symbols in it.
...
We will think of a [[function]] from $N$ to $K$ as a __$K$-valued $N$-sequence__, or simply a __sequence__.  The various sequence spaces will be [[subsets]] of the [[function set]] $K^N$ of all sequences.  In general, if â€˜$X$â€™ is the symbol for a sequence space, then we may specify $N$ and $K$ by writing â€˜$X(N,K)$â€™ (or a variation thereon), but often this is suppressed.
...
$$ \ess\forall k,\; a_k = 0 ,$$
where â€˜$\ess\forall$â€™ means 'for all but finitely many' ($\tilde{K}$-[[K-finite|finite]] in [[constructive mathematics]]).
...
where as usual $\epsilon$ is a [[positive number]] and again â€˜$\ess\forall$â€™ means 'for all but finitely many'.
...
This is also a [[Banach space]].  $c_\infty$ is also written simply â€˜$c$â€™, but this can be confusing; see the [Generalisations](#Generalisations) below.
...
This should probably be denoted â€˜$c$â€™, in line with the [generalisation](#Generalisations) below; but that symbol is often used for $c_\infty$, so it would be confusing.
...
The sequence spaces $c_c$, $c_0$, $c_\infty$, $c_b$, and $K^N$ generalise to the spaces $C_c$, $C_0$, $C_\infty$, $C_b$, and $C$ of [[continuous maps]] on a [[local compactum]].  In fact, $c_*(N)$ is simply $C_*(N,\tau)$, where $\tau$ is the [[discrete topology]].  (Note that one never uses the symbol â€˜$C$â€™ for â€˜$C_\infty$â€™ with capital letters.)
...
[[!redirects l_infinity space]]
[[!redirects l_infinity spaces]]
[[!redirects lâˆž-space]]
[[!redirects lâˆž-spaces]]
[[!redirects l-âˆž-space]]
[[!redirects l-âˆž-spaces]]
[[!redirects l^âˆž-space]]
[[!redirects l^âˆž-spaces]]
[[!redirects l_âˆž-space]]
[[!redirects l_âˆž-spaces]]
[[!redirects lâˆž space]]
[[!redirects lâˆž spaces]]
[[!redirects l-âˆž space]]
[[!redirects l-âˆž spaces]]
...
[[!redirects c_infty space]]
[[!redirects c_infty spaces]]
[[!redirects câˆž-space]]
[[!redirects câˆž-spaces]]
[[!redirects c-âˆž-space]]
[[!redirects c-âˆž-spaces]]
[[!redirects c_âˆž-space]]
[[!redirects c_âˆž-spaces]]
[[!redirects câˆž space]]
[[!redirects câˆž spaces]]
[[!redirects c-âˆž space]]
[[!redirects c-âˆž spaces]]
