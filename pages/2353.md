...
functors between [[(âˆž,1)-category|(âˆž,1)-categories]] discussed
below.
...
In the context of [[(âˆž,1)-category]] theory there is a good theory of [[Cartesian fibrations]] $X \to S$ and of their classification by [[(âˆž,1)-functors]] $S^{op} \to (\infty,1)Cat$ to the [[(âˆž,1)-category of (âˆž,1)-categories]] as described at [[universal fibration of (âˆž,1)-categories]].

Accordingly, the above notion of cograph of a functor has a direct generalization to [[(âˆž,1)-functors]]:

+-- {: .num_defn}
###### Definition

For $f : C \to D$ an [[(âˆž,1)-functor]], identified with a morphism

$$
  \bar f : I \to (\infty,1)Cat
$$

in the [[(âˆž,1)-category of (âˆž,1)-categories]], it **cograph** is the [[Cartesian fibration]] $cograph(f) \to I$ classified by it. In terms of the [[universal fibration of (âˆž,1)-categories]] this is the [[homotopy pullback]]
